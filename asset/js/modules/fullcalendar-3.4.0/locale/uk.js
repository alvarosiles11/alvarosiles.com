!(function (e) {
	...
	!(function () {
		...
		function _(t, _, n) {
			var a = {mm: _ ? 'хвилина_хвилини_хвилин' : 'хвилину_хвилини_хвилин', hh: _ ? 'година_години_годин' : 'годину_години_годин', dd: 'день_дні_днів', MM: 'місяць_місяці_місяців', yy: 'рік_роки_років'}
		...
		t.defineLocale('uk', {
			...
			relativeTime: {future: 'за %s', past: '%s тому', s: 'декілька секунд', m: _, mm: _, h: 'годину', hh: _, d: 'день', dd: _, M: 'місяць', MM: _, y: 'рік', yy: _},

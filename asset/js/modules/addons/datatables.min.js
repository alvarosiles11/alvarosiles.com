!(function (e) {
		...
		if (a)
			for (l = a.length - 1; l >= 0; l--) {
				...
				for (e.isArray(p) || (p = [p]), s = 0, u = p.length; u > s; s++)
					...
					else if ('string' == typeof p[s]) for (f = 0, c = h.length; c > f; f++) ('_all' == p[s] || e(h[f].nTh).hasClass(p[s])) && i(f, d)
			}
		...
		var a = function (t, n, i) {
			for (var o, u, f, c, d, l = K(i), s = l[l.length - 1], h = 0, p = l.length - 1; p > h; h++) {
				if (((u = l[h].match(Z)), (f = l[h].match(Q)), u)) {
					if (((l[h] = l[h].replace(Z, '')), (t[l[h]] = []), (o = l.slice()), o.splice(0, h + 1), (d = o.join('.')), e.isArray(n))) for (var v = 0, g = n.length; g > v; v++) (c = {}), a(c, n[v], d), t[l[h]].push(c)
					else t[l[h]] = n
					return
				}
	...
	function le(t, a, n, i) {
		...
		if (o) for (; o; ) (s = o.nodeName.toUpperCase()), ('TD' == s || 'TH' == s) && (g(o), l.push(o)), (o = o.nextSibling)
		else {
			l = a.anCells
	...
	function pe(t, a) {
		...
		for (l = 0, u = r.length; u > l; l++)
			for (n = r[l], d = 0, i = n.firstChild; i; ) {
				if ('TD' == i.nodeName.toUpperCase() || 'TH' == i.nodeName.toUpperCase()) for (h = 1 * i.getAttribute('colspan'), p = 1 * i.getAttribute('rowspan'), h = h && 0 !== h && 1 !== h ? h : 1, p = p && 0 !== p && 1 !== p ? p : 1, c = g(t, l, d), v = 1 === h ? !0 : !1, s = 0; h > s; s++) for (o = 0; p > o; o++) (t[l + o][c + s] = {cell: i, unique: v}), (t[l + o].nTr = n)
				i = i.nextSibling
			}
	}
	function ve(e, t, a) {
	...
	function We(t) {
		for (var a = t.oClasses, r = t.sTableId, n = t.aLengthMenu, i = e.isArray(n[0]), l = i ? n[0] : n, o = i ? n[1] : n, s = e('<select/>', {name: r + '_length', 'aria-controls': r, class: a.sLengthSelect}), u = 0, f = l.length; f > u; u++) s[0][u] = new Option('number' == typeof o[u] ? t.fnFormatNumber(o[u]) : o[u], l[u])
		...
		var p = e(d, {class: l.sScrollWrapper})
			.append(
				e(d, {class: l.sScrollHead})
					.css({overflow: 'hidden', position: 'relative', border: 0, width: n ? h(n) : '100%'})
					.append(
	...
	function Je(t) {
		...
		;(t.scrollBarVis = X),
			...
			(U = D.outerWidth()),
			'' === n ? ((w.width = '100%'), x && (D.find('tbody').height() > h.offsetHeight || 'scroll' == p.css('overflow-y')) && (w.width = Ke(D.outerWidth() - o)), (U = D.outerWidth())) : '' !== i && ((w.width = Ke(i)), (U = D.outerWidth())),
			qe(V, L),
			qe(function (t) {
			...
			D.outerWidth() < U ? ((E = h.scrollHeight > h.offsetHeight || 'scroll' == p.css('overflow-y') ? U + o : U), x && (h.scrollHeight > h.offsetHeight || 'scroll' == p.css('overflow-y')) && (w.width = Ke(E - o)), ('' === n || '' !== i) && ft(t, 1, 'Possible column misalignment', 6)) : (E = '100%'),
			(v.width = Ke(E)),
			(u.width = Ke(E)),
	...
	function $e(a) {
		...
		if (y || (!p && !o && !l && u == E(a) && u == c.length))
			...
			var x = e('<div/>')
				.css(o || l ? {position: 'absolute', top: 0, left: 0, height: 1, right: 0, overflow: 'hidden'} : {})
				.append(T)
				.appendTo(h)
	...
	function et(t) {
		...
		for (e.isArray(v) && m(v), g && v.pre && m(v.pre), m(t.aaSorting), g && v.post && m(v.post), a = 0; a < b.length; a++) for (p = b[a][0], c = f[p].aDataSort, l = 0, o = c.length; o > l; l++) (d = c[l]), (h = f[d].sType || 'string'), b[a]._idx === r && (b[a]._idx = e.inArray(b[a][1], f[d].asSorting)), s.push({src: p, col: d, dir: b[a][1], index: b[a]._idx, type: h, formatter: n.ext.type.order[h + '-pre']})
		return s
	}
	function tt(e) {
		var t,
			...
			return (
				this.each(function () {
					...
					;(w.nTable = this),
						...
						R(l),
						L(l.oLanguage),
						l.aLengthMenu && !l.iDisplayLength && (l.iDisplayLength = e.isArray(l.aLengthMenu[0]) ? l.aLengthMenu[0][0] : l.aLengthMenu[0]),
						(l = dt(e.extend(!0, {}, b), l)),
						ct(w.oFeatures, l, ['bPaginate', 'bLengthChange', 'bFilter', 'bSort', 'bSortMulti', 'bInfo', 'bProcessing', 'bAutoWidth', 'bSortClasses', 'bServerSide', 'bDeferRender']),
						ct(w, l, ['asStripeClasses', 'ajax', 'fnServerData', 'fnFormatNumber', 'sServerMethod', 'aaSorting', 'aaSortingFixed', 'aLengthMenu', 'sPaginationType', 'sAjaxSource', 'sAjaxDataProp', 'iStateDuration', 'sDom', 'bSortCellsTop', 'iTabIndex', 'fnStateLoadCallback', 'fnStateSaveCallback', 'renderer', 'searchDelay', 'rowId', ['iCookieDuration', 'iStateDuration'], ['oSearch', 'oPreviousSearch'], ['aoSearchCols', 'aoPreSearchCols'], ['iDisplayLength', '_iDisplayLength']]),
						ct(w.oScroll, l, [
							['sScrollX', 'sX'],
					...
					if ((0 !== M.length && (pe(w.aoHeader, M[0]), (P = ve(w))), null === l.aoColumns)) for (H = [], u = 0, f = P.length; f > u; u++) H.push(null)
					else H = l.aoColumns
					...
					var B = w.oFeatures,
						E = function () {
							...
							if ((0 === o.length && a.length > 0 && ('' !== w.oScroll.sX || '' !== w.oScroll.sY) && (o = e('<tfoot/>').appendTo(m)), 0 === o.length || 0 === o.children().length ? m.addClass(T.sNoFooter) : o.length > 0 && ((w.nTFoot = o[0]), pe(w.aoFooter, w.nTFoot)), l.aaData)) for (u = 0; u < l.aaData.length; u++) J(w, l.aaData[u])
	...
	;(l = function (t, a) {
		...
		e.extend(l.prototype, {
			...
			filter: function (e) {
				...
				else for (var a = 0, r = this.length; r > a; a++) e.call(this, this[a], a, this) && t.push(this[a])
			...
			iterator: function (e, t, a, n) {
				...
				for ('string' == typeof e && ((n = a), (a = t), (t = e), (e = !1)), s = 0, u = d.length; u > s; s++) {
					...
					else if ('column' === t || 'column-rows' === t || 'row' === t || 'cell' === t) for (p = this[s], 'column-rows' === t && (h = It(d[s], g.opts)), f = 0, c = p.length; c > f; f++) (v = p[f]), (o = 'cell' === t ? a.call(b, d[s], v.row, v.column, s, f) : a.call(b, d[s], v, s, f, h)), o !== r && i.push(o)
				}
				if (i.length || n) {
	...
	var Bt = function (t, a, n) {
		var u,
			...
			b = function (a) {
				...
				if (null === a || a === r || n) {
					for (c = [], d = 0, h = l.length; h > d; d++) for (u = l[d], p = 0; f > p; p++) (v = {row: u, column: p}), n ? ((g = i[u]), a(v, z(t, u, p), g.anCells ? g.anCells[p] : null) && c.push(v)) : c.push(v)
					return c
				}
	...
	o('cells()', function (t, a, n) {
		if ((e.isPlainObject(t) && (t.row === r ? ((n = t), (t = null)) : ((n = a), (a = null))), e.isPlainObject(a) && ((n = a), (a = null)), null === a || a === r))
		...
		this.iterator(
			'table',
			function (e, t) {
				for (o = [], s = 0, u = l[t].length; u > s; s++) for (f = 0, c = i[t].length; c > f; f++) o.push({row: l[t][s], column: i[t][f]})
			},
			1,
		)
		...
		o('order()', function (t, a) {
			...
			return t === r
				? 0 !== n.length
					? n[0].aaSorting
					: r
				: ('number' == typeof t ? (t = [[t, a]]) : t.length && !e.isArray(t[0]) && (t = Array.prototype.slice.call(arguments)),
				  this.iterator('table', function (e) {
						e.aaSorting = t.slice()
				  }))
		}),
		...
		s('columns().search()', 'column().search()', function (t, a, n, i) {
			return this.iterator('column', function (l, o) {
				...
				return t === r ? s[o].sSearch : void (l.oFeatures.bFilter && (e.extend(s[o], {sSearch: t + '', bRegex: null === a ? !1 : a, bSmart: null === n ? !0 : n, bCaseInsensitive: null === i ? !0 : i}), _e(l, l.oPreviousSearch, 1)))
			})
		}),
		o('state()', function () {
		...
		(n.ext = i = {buttons: {}, classes: {}, build: 'bs4/dt-1.10.18', errMode: 'alert', feature: [], search: [], selector: {cell: [], column: [], row: []}, internal: {}, legacy: {ajax: null}, pager: {}, renderer: {pageButton: {}, header: {}}, order: {}, type: {detect: [], search: {}, order: {}}, _unique: 0, fnVersionCheck: n.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: n.version}),
		e.extend(i, {afnFiltering: i.search, aTypes: i.type.detect, ofnSearch: i.type.search, oSort: i.type.order, afnSortData: i.order, aoFeatures: i.feature, oApi: i.internal, oStdClasses: i.classes, oPagination: i.pager}),
						...
						v = function (a, r) {
							...
							for (n = 0, l = r.length; l > n; n++)
								if (((b = r[n]), e.isArray(b))) {
									...
									null !== d &&
										((g = e('<a>', {class: u.sPageButton + ' ' + h, 'aria-controls': t.sTableId, 'aria-label': c[b], 'data-dt-idx': p, tabindex: t.iTabIndex, id: 0 === i && 'string' == typeof b ? t.sTableId + '_' + b : null})
											.html(d)
											.appendTo(a)),
										ht(g, {action: b}, m),
										p++)
				...
				jqueryui: function (t, a, r, n) {
					e('<div/>')
						...
						e(t.nTable).on('order.dt.DT', function (e, i, l, o) {
							if (t === i) {
								var s = r.idx
								a.removeClass(n.sSortAsc + ' ' + n.sSortDesc).addClass('asc' == o[s] ? n.sSortAsc : 'desc' == o[s] ? n.sSortDesc : r.sSortingClass),
									a
										.find('span.' + n.sSortIcon)
										.removeClass(n.sSortJUIAsc + ' ' + n.sSortJUIDesc + ' ' + n.sSortJUI + ' ' + n.sSortJUIAscAllowed + ' ' + n.sSortJUIDescAllowed)
										.addClass('asc' == o[s] ? n.sSortJUIAsc : 'desc' == o[s] ? n.sSortJUIDesc : r.sSortingClassJUI)
							}
						})
				},
			},
	...
	(function (e) {
		...
		return (
			...
			e.extend(n.ext.classes, {sWrapper: 'dataTables_wrapper dt-bootstrap4', sFilterInput: 'form-control form-control-sm', sLengthSelect: 'custom-select custom-select-sm form-control form-control-sm', sProcessing: 'dataTables_processing card', sPageButton: 'paginate_button page-item'}),
					...
					b = function (a, r) {
						...
						for (n = 0, i = r.length; i > n; n++)
							if (((m = r[n]), e.isArray(m))) b(a, m)
								...
								p &&
									((o = e('<li>', {class: c.sPageButton + ' ' + v, id: 0 === l && 'string' == typeof m ? t.sTableId + '_' + m : null})
										.append(e('<a>', {href: '#', 'aria-controls': t.sTableId, 'aria-label': h[m], 'data-dt-idx': g, tabindex: t.iTabIndex, class: 'page-link'}).html(p))
										.appendTo(a)),

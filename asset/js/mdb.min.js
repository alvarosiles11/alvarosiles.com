...
;(jQuery.easing.jswing = jQuery.easing.swing),
	jQuery.extend(jQuery.easing, {
		...
		easeOutBounce: function (t, e, i, n, o) {
			return (e /= o) < 1 / 2.75 ? n * (7.5625 * e * e) + i : e < 2 / 2.75 ? n * (7.5625 * (e -= 1.5 / 2.75) * e + 0.75) + i : e < 2.5 / 2.75 ? n * (7.5625 * (e -= 2.25 / 2.75) * e + 0.9375) + i : n * (7.5625 * (e -= 2.625 / 2.75) * e + 0.984375) + i
		},
						...
						var y = (function () {
							...
							return function t(e, n, o) {
								var a,
									...
									c = [0],
									u = 0
								for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = e, l.friction = n, (a = null !== o) ? (r = ((u = t(e, n)) / o) * 0.016) : (r = 0.016); (s = i(s || l, r)), c.push(1 + s.x), (u += 16), Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4; );
								return a
									? function (t) {
						...
						var x = function () {
							...
							function r() {
								function t(t) {
									...
									if ('scroll' === T) {
										...
										for (var E in (a(r).tweensContainer && !0 === a(r).isAnimating && (P = a(r).tweensContainer),
										...
										y)) {
											...
											if (a(r).isSVG || 'tween' === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
												...
												if (
													...
													(V = parseFloat(V) || 0),
													(R = parseFloat(R) || 0),
													'%' === B && (/^(fontSize|lineHeight)$/.test(E) ? ((R /= 100), (B = 'em')) : /^scale/.test(E) ? ((R /= 100), (B = '')) : /(Red|Green|Blue)$/i.test(E) && ((R = (R / 100) * 255), (B = ''))),
													/[\/*]/.test(Y))
												)
													B = j
												else if (j !== B && 0 !== V)
												...
												;(d[E] = {rootPropertyValue: z, startValue: V, currentValue: V, endValue: R, unitType: B, easing: W}), v.debug && console.log('tweensContainer (' + E + '): ' + JSON.stringify(d[E]), r)
							...
							if ((p.isWrapped(this) ? ((d = !1), (f = 0), (g = this), (h = this)) : ((d = !0), (f = 1), (g = k ? arguments[0].elements || arguments[0].e : arguments[0])), (g = o(g)))) {
								...
								switch (
									(d &&
										v.Promise &&
										(A.promise = new v.Promise(function (t, e) {
										...
										if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
											if (p.isString(y) && v.Redirects[y]) {
												...
												return (
													...
													u.each(g, function (t, e) {
														parseFloat(E.stagger) ? (E.delay = P + parseFloat(E.stagger) * t) : p.isFunction(E.stagger) && (E.delay = P + E.stagger.call(e, t, C)), E.drag && ((E.duration = parseFloat(O) || (/^(callout|transition)/.test(y) ? 1e3 : m)), (E.duration = Math.max(E.duration * (E.backwards ? 1 - t / C : (t + 1) / C), 0.75 * E.duration, 200))), v.Redirects[y].call(e, e, E || {}, t, C, g, A.promise ? A : n)
													}),
													t()
												)
											}
		...
		})()(
			{
				...
				3: [
					function (t, e, i) {
						...
						;(a.prototype = {
							...
							(a.prototype.spaces = {rgb: ['red', 'green', 'blue'], hsl: ['hue', 'saturation', 'lightness'], hsv: ['hue', 'saturation', 'value'], hwb: ['hue', 'whiteness', 'blackness'], cmyk: ['cyan', 'magenta', 'yellow', 'black']}),
					...
					function (t, e, i) {
						function n(t) {
							var e,
								...
								s = Math.max(n, o, a),
								l = s - r
							return s == r ? (e = 0) : n == s ? (e = (o - a) / l) : o == s ? (e = 2 + (a - n) / l) : a == s && (e = 4 + (n - o) / l), (e = Math.min(60 * e, 360)) < 0 && (e += 360), (i = (r + s) / 2), [e, 100 * (s == r ? 0 : i <= 0.5 ? l / (s + r) : l / (2 - s - r)), 100 * i]
						}
						function o(t) {
							var e,
								i,
						...
						function u(t) {
							var e = c(t),
								...
								n = e[1],
								o = e[2]
							return (n /= 100), (o /= 108.883), (i = (i /= 95.047) > 0.008856 ? Math.pow(i, 1 / 3) : 7.787 * i + 16 / 116), [116 * (n = n > 0.008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (i - n), 200 * (n - (o = o > 0.008856 ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116))]
						}
						function d(t) {
							var e,
								i,
						...
						function y(t) {
							var e,
								...
								r = t[1],
								s = t[2]
							return a <= 8 ? (o = ((i = (100 * a) / 903.3) / 100) * 7.787 + 16 / 116) : ((i = 100 * Math.pow((a + 16) / 116, 3)), (o = Math.pow(i / 100, 1 / 3))), [(e = e / 95.047 <= 0.008856 ? (e = (95.047 * (r / 500 + o - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + o, 3)), i, (n = n / 108.883 <= 0.008859 ? (n = (108.883 * (o - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(o - s / 200, 3))]
						}
						function x(t) {
							var e,
								i = t[0],
							...
							(e.exports = function (t) {
								...
								t.controllers.line = t.DatasetController.extend({
									...
									updateBezierControlPoints: function () {
										...
										else for (t = 0, e = s.length; t < e; ++t) (i = s[t]._model), (n = a.splineCurve(a.previousItem(s, t)._model, i, a.nextItem(s, t)._model, o.dataset._model.tension)), (i.controlPointPreviousX = n.previous.x), (i.controlPointPreviousY = n.previous.y), (i.controlPointNextX = n.next.x), (i.controlPointNextY = n.next.y)
							...
							(e.exports = function (t) {
								t.controllers.polarArea = t.DatasetController.extend({
									...
									updateElement: function (t, e, i) {
										...
										a.extend(t, {_datasetIndex: n.index, _index: e, _scale: c, _model: {x: d, y: h, innerRadius: 0, outerRadius: i ? v : f, startAngle: i && l.animateRotate ? p : m, endAngle: i && l.animateRotate ? p : g, label: a.valueAtIndexOrDefault(u, e, u[e])}})
							...
							update: function (t, e, i) {
								if (t) {
									...
									n.each(h.concat(f), N),
										...
										n.each(p, N),
										n.each(m, N),
										(t.chartArea = {left: O, top: _, right: O + k, bottom: _ + C}),
										n.each(g, function (e) {
				...
				33: [
					function (t, e, i) {
						...
						n._set('scale', {display: !0, position: 'left', offset: !1, gridLines: {display: !0, color: 'rgba(0, 0, 0, 0.1)', lineWidth: 1, drawBorder: !0, drawOnChartArea: !0, drawTicks: !0, tickMarkLength: 10, zeroLineWidth: 1, zeroLineColor: 'rgba(0,0,0,0.25)', zeroLineBorderDash: [], zeroLineBorderDashOffset: 0, offsetGridLines: !1, borderDash: [], borderDashOffset: 0}, scaleLabel: {display: !1, labelString: '', lineHeight: 1.2, padding: {top: 4, bottom: 4}}, ticks: {beginAtZero: !1, minRotation: 0, maxRotation: 50, mirror: !1, padding: 0, reverse: !1, display: !0, autoSkip: !0, autoSkipPadding: 0, labelOffset: 0, callback: r.formatters.values, minor: {}, major: {}}}),
							(e.exports = o.extend({
								getPadding: function () {
										...
										if (
											(a.each(g, function (n, o) {
												if (!a.isNullOrUndef(n.label)) {
													...
													T.push({tx1: v, ty1: y, tx2: b, ty2: x, x1: k, y1: C, x2: S, y2: D, labelX: E, labelY: L, glWidth: c, glColor: u, glBorderDash: d, glBorderDashOffset: p, rotation: -1 * M, label: F, major: n.major, textBaseline: R, textAlign: $})
												}
											}),
											a.each(T, function (t) {
											...
											if (m) (D = e.left + (e.right - e.left) / 2), (E = 'bottom' === i.position ? e.bottom - F - S.bottom : e.top + F + S.top)
												...
												var $ = 'left' === i.position
												;(D = $ ? e.left + F + S.top : e.right - F - S.top), (E = e.top + (e.bottom - e.top) / 2), (L = $ ? -0.5 * Math.PI : 0.5 * Math.PI)
											}
				...
				38: [
					function (t, e, i) {
						...
						var n = t(26),
							...
							a = t(46),
							r = n.global
						n._set('global', {elements: {line: {tension: 0.4, backgroundColor: r.defaultColor, borderWidth: 3, borderColor: r.defaultColor, borderCapStyle: 'butt', borderDash: [], borderDashOffset: 0, borderJoinStyle: 'miter', capBezierPoints: !0, fill: !0}}}),
							(e.exports = o.extend({
								draw: function () {
									var t,
										e,
							...
							draw: function () {
								...
								if (o.display) {
									var s,
										...
										b = t.bottom,
										x = t.right
									;(e.fillStyle = i(o.fontColor, r.defaultFontColor)), (e.font = p), t.isHorizontal() ? ((l = y + (x - y) / 2), (c = v + m), (s = x - y)) : ((l = 'left' === o.position ? y + m : x - m), (c = v + (b - v) / 2), (s = b - v), (g = Math.PI * ('left' === o.position ? -0.5 : 0.5))), e.save(), e.translate(l, c), e.rotate(g), (e.textAlign = 'center'), (e.textBaseline = 'middle')
									var w = o.text
			...
			(t.ripple = function (t, e) {
				...
				if ((((e = e || {}).wait = e.wait || 0), (e.position = e.position || null), i))
					for (
						...
						if (((n = t[u]), (o = e.position || {x: n.clientWidth / 2, y: n.clientHeight / 2}), (s = r(n)), (c.x = s.left + o.x), (c.y = s.top + o.y), (d.pageX = c.x), (d.pageY = c.y), l.show(d, n), e.wait >= 0 && null !== e.wait)) {
					...
					if ((r(), i.after(a), n.hover)) {
						...
						i.unbind('click.'.concat(i.attr('id'))),
							i.bind('click.'.concat(i.attr('id')), function (e) {
								o ||
									(i[0] !== e.currentTarget || i.hasClass('active') || 0 !== t(e.target).closest('.dropdown-content').length ? i.hasClass('active') && (l(), t(document).unbind('click.'.concat(a.attr('id'), ' touchstart.').concat(a.attr('id')))) : (e.preventDefault(), s('click')),
									a.hasClass('active') &&
...
dropdownSelectors.on({
				...
				return (
					_createClass(d, [
						...
						},
						{
							...
							value: function (t) {
								if ('touchend' === t.type) {
									...
									o > 0 && (o = 0), a < 0 && (a = 0), 'left' === this.options.edge ? ((this.menuOut && i <= 0.3) || i < -0.5 ? (0 !== o && this.translateMenuX([0, o], '300'), this.showSidenavOverlay()) : (!this.menuOut || i > 0.3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, o], '200'), this.hideSidenavOverlay()), this.$dragTarget.css({width: '10px', right: '', left: 0})) : (this.menuOut && i >= -0.3) || i > 0.5 ? (this.translateMenuX([0, a], '300'), this.showSidenavOverlay(), this.$dragTarget.css({width: '50%', right: '', left: 0})) : (!this.menuOut || i < -0.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10, a], '200'), this.hideSidenavOverlay(), this.$dragTarget.css({width: '10px', right: 0, left: ''}))
								}
							},
						},
						{
						...
						},
						{
							...
							value: function (t) {
								if ('touch' === t.gesture.pointerType) {
									...
									n > 0 && (n = 0), o < 0 && (o = 0), 'left' === this.options.edge ? ((this.menuOut && e <= 0.3) || e < -0.5 ? (0 !== n && this.translateMenuX([0, n], '300'), this.showSidenavOverlay()) : (!this.menuOut || e > 0.3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, n], '200'), this.hideSidenavOverlay()), this.$dragTarget.css({width: '10px', right: '', left: 0})) : (this.menuOut && e >= -0.3) || e > 0.5 ? (this.translateMenuX([0, o], '300'), this.showSidenavOverlay(), this.$dragTarget.css({width: '50%', right: '', left: 0})) : (!this.menuOut || e < -0.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10, o], '200'), this.hideSidenavOverlay(), this.$dragTarget.css({width: '10px', right: 0, left: ''}))
								}
							},
						},
						{
								...
								this.$element.on('click', function (i) {
									if ((i.preventDefault(), !0 === e.menuOut)) e.removeMenu()
										...
										;(n = 'left' === e.options.edge ? [0, -1 * e.options.MENU_WIDTH] : [0, e.options.MENU_WIDTH]),
											'matrix(1, 0, 0, 1, 0, 0)' !== e.$menu.css('transform') && e.$menu.velocity({translateX: n}, {duration: e.options.timeDurationOpen, queue: !1, easing: e.options.easingOpen}),
						...
						},
						{
							...
							value: function () {
								var e = this
								'left' === this.options.edge ? (this.$menu.css('transform', 'translateX(-100%)'), this.$dragTarget.css({left: 0})) : (this.$menu.addClass('right-aligned').css('transform', 'translateX(100%)'), this.$dragTarget.css({right: 0})),
	...
	$(function (t) {
		t('#toggle').click(function () {
			t('#slide-out').hasClass('slim') ? (t('#slide-out').removeClass('slim'), t('.sv-slim-icon').removeClass('fa-angle-double-right').addClass('fa-angle-double-left')) : (t('#slide-out').addClass('slim'), t('.sv-slim-icon').removeClass('fa-angle-double-left').addClass('fa-angle-double-right'))
		})
	}),
	(function (t) {
	...
	(function (t, e) {
		...
		var e = function (t, e) {
				...
				var a = 1
				window.devicePixelRatio > 1 && ((a = window.devicePixelRatio), (n.style.width = n.style.height = [e.size, 'px'].join('')), (n.width = n.height = e.size * a), o.scale(a, a)), o.translate(e.size / 2, e.size / 2), o.rotate((e.rotate / 180 - 0.5) * Math.PI)
			...
			i = (function () {
				function e(i, n) {
					_classCallCheck(this, e),
						...
						(this.$toggleAll = t('<li class="select-toggle-all"><span><input type="checkbox" class="form-check-input"><label>'.concat(this.selectAllLabel, '</label></span></li>'))),
						(this.$addOptionBtn = t('<i class="select-add-option fas fa-plus"></i>')),
						(this.mainLabel = this.$nativeSelect.next('.mdb-main-label')),
						(this.$validFeedback = t('<div class="valid-feedback">'.concat(this.options.validFeedback || 'Good choice', '</div>'))),
						(this.$invalidFeedback = t('<div class="invalid-feedback">'.concat(this.options.invalidFeedback || 'Bad choice', '</div>'))),
						(this.valuesSelected = []),
						...
						[
							...
							},
							{
								...
								value: function () {
									if ((Boolean(this.$nativeSelect.data('select-id')) && this._removeMaterialWrapper(), this.options.destroy)) {
										var t = !!this.$nativeSelect.parent().find('button.btn-save').length && this.$nativeSelect.parent().find('button.btn-save')
										return this.$nativeSelect.data('select-id', null).removeClass('initialized'), void this.$nativeSelect.parent().append(t)
									}
									...
									0 === this.mainLabel.length ? this.$materialSelect.val(e) : this.mainLabel.text(),
										...
										this.options.language.active && this.$toggleAll && (this.options.language.pl && this.$toggleAll.find('label').text(this.options.language.pl.selectAll ? this.options.language.pl.selectAll : this.defaults.language.pl.selectAll), this.options.language.fr && this.$toggleAll.find('label').text(this.options.language.fr.selectAll ? this.options.language.fr.selectAll : this.defaults.language.fr.selectAll), this.options.language.ge && this.$toggleAll.find('label').text(this.options.language.ge.selectAll ? this.options.language.ge.selectAll : this.defaults.language.ge.selectAll), this.options.language.ar && this.$toggleAll.find('label').text(this.options.language.ar.selectAll ? this.options.language.ar.selectAll : this.defaults.language.ar.selectAll), this.options.language.in && this.$toggleAll.find('label').text(this.options.language.in.selectAll ? this.options.language.in.selectAll : this.defaults.language.in.selectAll)),
										this.$materialSelect.hasClass('custom-select') && this.$materialSelect.hasClass('select-dropdown') && this.$materialSelect.css({display: 'inline-block', width: '100%', height: 'calc(1.5em + .75rem + 2px)', padding: '.375rem 1.75rem .375rem .75rem', fontSize: '1rem', lineHeight: '1.5', backgroundColor: '#fff', border: '1px solid #ced4da'})
								},
							},
							{
							...
							},
							{
								...
								value: function () {
									...
									this.isMultple ||
										this.$nativeSelectChildren.each(function (e, i) {
											t(i).attr('selected', !1)
										}),
							...
							},
							{
								...
								value: function (e) {
									var i = this,
										...
										o = !t(n).prop('checked')
									t(n).prop('checked', o),
										this.$materialOptionsList.find('li:not(.optgroup):not(.select-toggle-all)').each(function (e, n) {
								...
								value: function (e) {
									...
									if ((this._escapeKeyboardActiveOptions(), this.isSearchable)) {
										...
										if (s && -1 === l.indexOf(e.which)) {
											r += s
											var c = this.$materialOptionsList
												.find('li')
												.filter(function (e, i) {
							...
							},
							{
								...
								value: function (e) {
									...
									if (
										...
										return this.isEditable && !d ? void this.addNewOption() : (r && this._handleEnterWithShiftKey(i), void this.$materialSelect.trigger('open'))
							...
							},
							{
								...
								value: function () {
									...
									this.options.language.active && this.$toggleAll && (this.options.language.pl ? (i = this.options.language.pl.optionsSelected ? this.options.language.pl.optionsSelected : this.defaults.language.pl.optionsSelected) : this.options.language.fr ? (i = this.options.language.fr.optionsSelected ? this.options.language.fr.optionsSelected : this.defaults.language.fr.optionsSelected) : this.options.language.ge ? (i = this.options.language.ge.optionsSelected ? this.options.language.ge.optionsSelected : this.defaults.language.ge.optionsSelected) : this.options.language.ar ? (i = this.options.language.ar.optionsSelected ? this.options.language.ar.optionsSelected : this.defaults.language.ar.optionsSelected) : this.options.language.in && (i = this.options.language.in.optionsSelected ? this.options.language.in.optionsSelected : this.defaults.language.in.optionsSelected)),
										...
										e.length > 0 && !this.options.BSinputText ? this.mainLabel.addClass('active ') : this.mainLabel.removeClass('active'),
					...
					start: function () {
						return p && p.start
							...
							: ((p.methods = {}),
							  ...
							  (b.$root = t('<div class="' + m.picker + '" id="' + e.id + '_root" />')),
							  l(b.$root[0], 'hidden', !0),
							  (b.$holder = t(x()).appendTo(b.$root)),
							  w(),
							  f.formatSubmit &&
									(function () {
										var i
										...
										;(b._hidden = t('<input type=hidden name="' + i + '"' + (g.data('value') || e.value ? ' value="' + b.get('select', f.formatSubmit) + '"' : '') + '>')[0]),
							  ...
							  (function () {
									g
										.data(n, b)
										.addClass(m.input)
										.val(g.data('value') ? b.get('select', f.format) : e.value)
										.on(
							  ...
							  f.containerHidden ? t(f.containerHidden).append(b._hidden) : g.after(b._hidden),
							  f.container ? t(f.container).append(b.$root) : g.after(b.$root),
							  b.on({start: b.component.onStart, render: b.component.onRender, stop: b.component.onStop, open: b.component.onOpen, close: b.component.onClose, set: b.component.onSet}).on({start: f.onStart, render: f.onRender, stop: f.onStop, open: f.onOpen, close: f.onClose, set: f.onSet}),
							  (h = (function (t) {
									var e
		...
		;(o.prototype.set = function (t, e, i) {
			...
			return null === e
				...
				: ((o['enable' == t ? 'disable' : 'flip' == t ? 'enable' : t] = n.queue[t]
						...
						.pop()),
				  'select' == t ? n.set('highlight', o.select, i) : 'highlight' == t ? n.set('view', o.highlight, i) : t.match(/^(flip|min|max|disable|enable)$/) && (o.select && n.disabled(o.select) && n.set('select', o.select, i), o.highlight && n.disabled(o.highlight) && n.set('highlight', o.highlight, i)),
				  n)
		}),
			...
			(o.prototype.nodes = function (t) {
				var e,
					...
					m = function (t) {
						return n.node('button', ' ', a.klass['nav' + (t ? 'Next' : 'Prev')] + ((t && u.year >= p.year && u.month >= p.month) || (!t && u.year <= h.year && u.month <= h.month) ? ' ' + a.klass.navDisabled : ''), 'data-nav=' + (t || -1) + ' ' + n.ariaAttr({role: 'button', controls: o.$node[0].id + '_table'}) + ' title="' + (t ? a.labelMonthNext : a.labelMonthPrev) + '"')
					},
					g = function () {
	...
	(function () {
		...
		function M(t, e) {
			...
			e.darktheme && r.addClass('darktheme'),
				...
				O.on('click.clockpicker', m(n.proxy(this.show, this), 100))
			var E,
				L,
				F,
				$,
				R = n('<div class="clockpicker-tick"></div>')
			if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) (L = R.clone()), (F = (E / 6) * Math.PI), ($ = b), L.css('font-size', '140%'), L.css({left: y + Math.sin(F) * $ - w, top: y - Math.cos(F) * $ - w}), L.html(0 === E ? 12 : E), p.append(L), L.on(u, N)
			else
				for (E = 0; E < 24; E += e.hourstep) {
					;(L = R.clone()), (F = (E / 6) * Math.PI)
					var W = E > 0 && E < 13
					;($ = W ? x : b), L.css({left: y + Math.sin(F) * $ - w, top: y - Math.cos(F) * $ - w}), W && L.css('font-size', '120%'), L.html(0 === E ? '00' : E), p.append(L), L.on(u, N)
				}
			var V = Math.max(e.minutestep, 5)
			for (E = 0; E < 60; E += V) for (E = 0; E < 60; E += 5) (L = R.clone()), (F = (E / 30) * Math.PI), L.css({left: y + Math.sin(F) * b - w, top: y - Math.cos(F) * b - w}), L.css('font-size', '140%'), L.html(g(E)), M.append(L), L.on(u, N)
			function N(t, i) {
				var n = l.offset(),
					o = /^touch/.test(t.type),
					r = n.left + y,
				...
				if (!this.isShown) {
					...
					this.input.blur(),
						...
						this.isAppended ||
							...
							this.options.twelvehour && ((this.amOrPm = 'PM'), this.options.ampmclickable ? (this.spanAmPm.children('#click-pm').addClass('text-primary'), this.spanAmPm.children('#click-am').removeClass('text-primary')) : (this.amPmBlock.children('.am-button').removeClass('active'), this.amPmBlock.children('.pm-button').addClass('active'), this.spanAmPm.empty().append('PM'))),
	...
	(function (t, e) {
		...
		return function (t, e, i, n) {
			...
			var s,
				...
				Ft = null,
				$t = function () {
					Ft && (o.unbind(document, 'mousemove', $t), o.addClass(t, 'pswp--has_mouse'), (r.mouseUsed = !0), St('mouseUsed')),
				...
				Te = function (t) {
					if (!('mousedown' === t.type && t.button > 0)) {
						...
						if (!B || 'mousedown' !== t.type) {
							...
							var i = Se(t),
								n = i.length
							;(Q = null), Ut(), (j && 1 !== n) || ((j = nt = !0), o.bind(window, p, a), (z = rt = ot = H = K = X = Y = q = !1), (it = null), St('firstTouchStart', i), Et(ct, ut), (lt.x = lt.y = 0), Et(te, i[0]), Et(ee, te), (ne.x = ft.x * ht), (oe = [{x: te.x, y: te.y}]), (V = W = Mt()), Rt(g, !0), pe(), fe()), !Z && n > 1 && !et && !K && ((v = g), (q = !1), (Z = Y = !0), (lt.y = lt.x = 0), Et(ct, ut), Et(Zt, i[0]), Et(Gt, i[1]), be(Zt, Gt, de), (ue.x = Math.abs(de.x) - ut.x), (ue.y = Math.abs(de.y) - ut.y), (G = he(Zt, Gt)))
						}
					}
				},
				Ae = function (t) {
					...
					var t,
						...
						i = {
							...
							panAnimLoop: function () {
								return jt.zoomPan && ((jt.zoomPan.raf = _(i.panAnimLoop)), (i.now = Mt()), (i.timeDiff = i.now - i.lastNow), (i.lastNow = i.now), i.calculateAnimOffset('x'), i.calculateAnimOffset('y'), It(), i.calculateOverBoundsAnimOffset('x'), i.calculateOverBoundsAnimOffset('y'), i.speedDecelerationRatioAbs.x < 0.05 && i.speedDecelerationRatioAbs.y < 0.05) ? ((ut.x = Math.round(ut.x)), (ut.y = Math.round(ut.y)), It(), void qt('zoomPan')) : void 0
							},
						}
					return i
				},
				_e = function (t) {
					return t.calculateSwipeSpeed('y'), (J = a.currItem.bounds), (t.backAnimDestination = {}), (t.backAnimStarted = {}), Math.abs(t.lastFlickSpeed.x) <= 0.05 && Math.abs(t.lastFlickSpeed.y) <= 0.05 ? ((t.speedDecelerationRatioAbs.x = t.speedDecelerationRatioAbs.y = 0), t.calculateOverBoundsAnimOffset('x'), t.calculateOverBoundsAnimOffset('y'), !0) : (Xt('zoomPan'), (t.lastNow = Mt()), void t.panAnimLoop())
				},
				De = function (t, e) {
					var i, n, s
					if ((et || (re = u), 'swipe' === t)) {
					...
					return (
						...
						Kt('mainScroll', ce.x, h, d, o.easing.cubic.out, _t, function () {
			...
			;(x.init = function () {
				...
				(x.getFullscreenAPI = function () {
					var e,
						...
						n = 'fullscreenchange'
					return (
						i.requestFullscreen ? (e = {enterK: 'requestFullscreen', exitK: 'exitFullscreen', elementK: 'fullscreenElement', eventK: n}) : i.mozRequestFullScreen ? (e = {enterK: 'mozRequestFullScreen', exitK: 'mozCancelFullScreen', elementK: 'mozFullScreenElement', eventK: 'moz' + n}) : i.webkitRequestFullscreen ? (e = {enterK: 'webkitRequestFullscreen', exitK: 'webkitExitFullscreen', elementK: 'webkitFullscreenElement', eventK: 'webkit' + n}) : i.msRequestFullscreen && (e = {enterK: 'msRequestFullscreen', exitK: 'msExitFullscreen', elementK: 'msFullscreenElement', eventK: 'MSFullscreenChange'}),
						e &&
							((e.enter = function () {
...
initPhotoSwipeFromDOM('.mdb-lightbox'),
		...
		var w = function (t, e, i, n, o) {
			...
			C = function (t) {
				...
				;(t.containerWidth = e.clientWidth),
					...
					!t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? ((t.scrollbarXActive = !0), (t.railXWidth = t.containerWidth - t.railXMarginWidth), (t.railXRatio = t.containerWidth / t.railXWidth), (t.scrollbarXWidth = h(t, u((t.railXWidth * t.containerWidth) / t.contentWidth))), (t.scrollbarXLeft = u(((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth)) / (t.contentWidth - t.containerWidth)))) : (t.scrollbarXActive = !1),
			...
			M = function (n, o) {
				...
				for (var r in ((this.element = n), n.classList.add(g.main), (this.settings = {handlers: ['click-rail', 'drag-thumb', 'keyboard', 'wheel', 'touch'], maxScrollbarLength: null, minScrollbarLength: null, scrollingThreshold: 1e3, scrollXMarginOffset: 0, scrollYMarginOffset: 0, suppressScrollX: !1, suppressScrollY: !1, swipeEasing: !0, useBothWheelAxes: !1, wheelPropagation: !0, wheelSpeed: 1}), o)) a.settings[r] = o[r]
				...
				;(this.scrollbarYRight = parseInt(d.right, 10)),
					...
					(this.reach = {x: n.scrollLeft <= 0 ? 'start' : n.scrollLeft >= this.contentWidth - this.containerWidth ? 'end' : null, y: n.scrollTop <= 0 ? 'start' : n.scrollTop >= this.contentHeight - this.containerHeight ? 'end' : null}),
					(this.isAlive = !0),
				...
				var w =
					...
					C = (function () {
						function t(e, i) {
							...
							var o = this
							;(o.instanceID = k++), (o.$item = e), (o.defaults = {type: 'scroll', speed: 0.5, imgSrc: null, imgElement: '.jarallax-img', imgSize: 'cover', imgPosition: '50% 50%', imgRepeat: 'no-repeat', keepImg: !1, elementInViewport: null, zIndex: -100, disableParallax: !1, disableVideo: !1, automaticResize: !0, videoSrc: null, videoStartTime: 0, videoEndTime: 0, videoVolume: 0, videoPlayOnlyVisible: !0, onScroll: null, onInit: null, onDestroy: null, onCoverImage: null})
								...
								},
								{
									...
									value: function () {
										...
										if (
											...
											this.image.useImgTag ? (e = this.extend({'object-fit': this.options.imgSize, 'object-position': this.options.imgPosition, 'font-family': 'object-fit: ' + this.options.imgSize + '; object-position: ' + this.options.imgPosition + ';', 'max-width': 'none'}, t, e)) : ((this.image.$item = document.createElement('div')), this.image.src && (e = this.extend({'background-position': this.options.imgPosition, 'background-size': this.options.imgSize, 'background-repeat': this.options.imgRepeat, 'background-image': 'url("' + this.image.src + '")'}, t, e))),
	...
	(function (t) {
		var e = {},
			...
			d = (function () {
				function d(c, u) {
					_classCallCheck(this, d), (this.defaults = {data: e, dataColor: i, closeColor: n, closeBlurColor: o, inputFocus: a, inputBlur: r, inputFocusShadow: s, inputBlurShadow: l}), (this.$input = c), (this.options = this.assignOptions(u)), (this.$clearButton = t('.mdb-autocomplete-clear')), (this.$autocompleteWrap = t('<ul class="mdb-autocomplete-wrap"></ul>')), this.init()
				}
				return (
					_createClass(d, [
						{

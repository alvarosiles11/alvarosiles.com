...
!(function (t) {
	...
	var Ee = (Zt.DayTableMixin = {
			...
			sliceRangeByDay: function (t) {
				var e,
					...
					c = []
				for (e = 0; e < this.rowCnt; e++) for (n = e * a, i = n + a - 1, r = n; r <= i; r++) (s = Math.max(u, r)), (o = Math.min(h, r)), (s = Math.ceil(s)), (o = Math.floor(o)), s <= o && c.push({row: e, firstRowDayIndex: s - n, lastRowDayIndex: o - n, isStart: s === u, isEnd: o === h})
				return c
			},
		...
		De = (Zt.DayGrid = be.extend(Ee, {
			...
			renderDates: function (t) {
				...
				for (this.el.html(o), this.rowEls = this.el.find('.fc-row'), this.cellEls = this.el.find('.fc-day, .fc-disabled-day'), this.rowCoordCache = new ve({els: this.rowEls, isVertical: !0}), this.colCoordCache = new ve({els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0}), e = 0; e < r; e++) for (n = 0; n < s; n++) i.publiclyTrigger('dayRender', null, this.getCellDate(e, n), this.getCellEl(e, n))
			},
			unrenderDates: function () {
	...
	Re.mixin({
		...
		(Re.rtlDefaults = {header: {left: 'next,prev today', center: '', right: 'title'}, buttonIcons: {prev: 'right-single-arrow', next: 'left-single-arrow', prevYear: 'right-double-arrow', nextYear: 'left-double-arrow'}, themeButtonIcons: {prev: 'circle-triangle-e', next: 'circle-triangle-w', nextYear: 'seek-prev', prevYear: 'seek-next'}})
	var xe = (Zt.locales = {})

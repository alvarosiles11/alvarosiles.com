	...
	r(l, [], function () {
		...
		r(f, [c, d], function (e, t) {
			...
			function s() {
				...
				var t = this,
					...
					d,
					f
				;(u = l + (+new Date()).toString(32)),
					(d = 'onmouseenter' in document.documentElement),
					(c = 'onfocusin' in document.documentElement),
					(f = {mouseenter: 'mouseover', mouseleave: 'mouseout'}),
					(s = 1),
					(t.domLoaded = !1),
					(t.events = i),
					(t.bind = function (r, l, p, h) {
						function m(t) {
							e(o(t || E.event), g)
						}
						var g,
						...
						if (r && 3 !== r.nodeType && 8 !== r.nodeType) {
							for (r[u] ? (g = r[u]) : ((g = s++), (r[u] = g), (i[g] = {})), h = h || r, l = l.split(' '), y = l.length; y--; )
								(b = l[y]),
									(x = m),
									(C = w = !1),
									...
									t.domLoaded && 'ready' === b && 'complete' == r.readyState
										...
										: (d ||
										  ...
										  (v = i[g][b]),
										  v ? ('ready' === b && t.domLoaded ? p({type: b}) : v.push({func: p, scope: h})) : ((i[g][b] = v = [{func: p, scope: h}]), (v.fakeName = C), (v.capture = w), (v.nativeHandler = x), 'ready' === b ? a(r, x, t) : n(r, C || b, x, w)))
							return (r = v = 0), p
						}
					}),
					...
					(t.fire = function (n, r, i) {
						...
						do (a = n[u]), a && e(i, a), (n = n.parentNode || n.ownerDocument || n.defaultView || n.parentWindow)
		...
		r(p, [], function () {
			...
			;(x = e.support = {}),
					...
					function (e) {
						...
						return r !== D && 9 === r.nodeType && r.documentElement
							? ((D = r),
							  ...
							  (x.matchesSelector = ge.test((H = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector))) &&
									i(function (e) {
				...
				(e.matchesSelector = function (t, n) {
					if (((t.ownerDocument || t) !== D && B(t), (n = n.replace(ce, "='$1']")), x.matchesSelector && M && (!O || !O.test(n)) && (!P || !P.test(n))))
						try {
							var r = H.call(t, n)
								...
								return 1 === r && 0 === i
									...
									: function (t, n, l) {
											...
											if (g) {
												...
												else for (; (d = (++p && d && d[m]) || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[F] || (d[F] = {}))[e] = [U, f]), d !== t)); );
						...
						pseudos: {
							...
							lang: r(function (t) {
								return (
									...
									function (e) {
										var n
										do if ((n = M ? e.lang : e.getAttribute('xml:lang') || e.getAttribute('lang'))) return (n = n.toLowerCase()), n === t || 0 === n.indexOf(t + '-')
				...
				(_ = e.tokenize =
					function (t, n) {
						...
						for (s = t, l = [], u = w.preFilter; s; ) {
							...
							for (a in w.filter) !(i = pe[a].exec(s)) || (u[a] && !(i = u[a](i))) || ((r = i.shift()), o.push({value: r, type: a, matches: i}), (s = s.slice(r.length)))
							if (!r) break
						}
		...
		r(g, [f, p, m, d], function (e, n, r, i) {
			...
			function u(e, t, n, r) {
				...
				if (a(t)) t = l(t, v(e[0]))
					...
					if (((t = f.makeArray(t)), r)) for (i = t.length - 1; i >= 0; i--) u(e, t[i], n, r)
					else for (i = 0; i < t.length; i++) u(e, t[i], n, r)
					return e
				}
				...
				(f.fn = f.prototype =
					{
						...
						init: function (e, t) {
							...
							if (a(e)) {
								...
								if (r[1]) for (i = l(e, v(t)).firstChild; i; ) E.call(n, i), (i = i.nextSibling)
								else {
				...
				return {
					...
					parse: function (t) {
						...
						if (t) {
							for (
								t = t.replace(/[\u0000-\u001F]/g, ''),
									t = t.replace(/\\[\"\';:\uFEFF]/g, p).replace(/\"[^\"]+\"|\'[^\']+\'/g, function (e) {
					...
					serialize: function (e, t) {
						...
						var i = '',
							...
							a
						if (t && c) n('*'), n(t)
						else for (o in e) (a = e[o]), !a || (d && !r(o, t)) || (i += (i.length > 0 ? ' ' : '') + o + ': ' + a + ';')
						return i
					},
				}
			}
		...
		r(w, [p, g, v, f, y, b, C, d, m, x], function (e, n, r, i, o, a, s, l, u, c) {
			...
			function h(e, t) {
				...
				;(o.doc = e),
					...
					(o.styleSheetLoader = new c(e)),
					(o.boundEvents = []),
					(o.settings = t = t || {}),
					(o.schema = t.schema),
					(o.styles = new r({url_converter: t.url_converter, url_converter_scope: t.url_converter_scope}, t.schema)),
					o.fixDoc(e),
				...
				(h.prototype = {
					...
					getPos: function (e, t) {
						...
						if (((e = r.get(e)), (t = t || l), e)) {
							if (t === l && e.getBoundingClientRect && 'static' === n(l).css('position')) return (u = e.getBoundingClientRect()), (t = r.boxModel ? s.documentElement : l), (i = u.left + (s.documentElement.scrollLeft || l.scrollLeft) - t.clientLeft), (o = u.top + (s.documentElement.scrollTop || l.scrollTop) - t.clientTop), {x: i, y: o}
			...
			function n() {
				...
				;(this.isDone = function (e) {
					...
					(this.loadScripts = function (t, n, r, d) {
						...
						var v,
							y = []
						p.push({success: n, failure: d, scope: r || this}),
							(v = function () {
								var n = o(t)
								;(t.length = 0),
									i(n, function (t) {
		...
		r(B, [m], function (e) {
			...
			function n(e) {
				...
				return i[e]
					? i[e]
					: ((l = 'id accesskey class dir lang style tabindex title'),
					  (u = 'address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul'),
					  ...
					  'html4' != e && ((l += ' contenteditable contextmenu draggable dropzone hidden spellcheck translate'), (u += ' article aside details dialog figure header footer hgroup section nav'), (c += ' audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen')),
					  'html5-strict' != e &&
							((l += ' xml:lang'),
							(p = 'acronym applet basefont big font strike tt'),
							(c = [c, p].join(' ')),
							s(t(p), function (e) {
								n(e, '', c)
							}),
							(f = 'center dir isindex noframes'),
							(u = [u, f].join(' ')),
							(d = [u, c].join(' ')),
							s(t(f), function (e) {
								n(e, '', d)
					  ...
					  n('object', 'data type typemustmatch name usemap form width height', [d, 'param'].join(' ')),
					  n('param', 'name value'),
					  n('map', 'name', [d, 'area'].join(' ')),
					  ...
					  n('fieldset', 'disabled form name', [d, 'legend'].join(' ')),
					  n('label', 'form for', c),
					  ...
					  n('button', 'disabled form formaction formenctype formmethod formnovalidate formtarget name type value', 'html4' == e ? d : c),
					  ...
					  'html4' != e &&
							...
							n('video', 'src crossorigin poster preload autoplay mediagroup loop muted controls width height buffered', [d, 'track source'].join(' ')),
							n('audio', 'src crossorigin preload autoplay mediagroup loop muted controls buffered volume', [d, 'track source'].join(' ')),
					  ...
					  'html4' != e && (r('input button select textarea', 'autofocus'), r('input textarea', 'placeholder'), r('a', 'download'), r('link script img', 'crossorigin'), r('iframe', 'sandbox seamless allowfullscreen')),
			...
			return function (e) {
				...
				;(e = e || {}),
					...
					(N = o('whitespace_elements', 'pre script noscript style textarea video audio iframe object code')),
					...
					(A = o('non_empty_elements', 'td th iframe video audio object script pre code', S)),
					...
					m('+ol[ul|ol],+ul[ul|ol]'),
					s({dd: 'dl', dt: 'dl', li: 'ul ol', td: 'tr', th: 'tr', tr: 'tbody thead tfoot', tbody: 'table', thead: 'table', tfoot: 'table', legend: 'fieldset', area: 'map', param: 'video audio object'}, function (e, n) {
						y[n] && (y[n].parentsRequired = t(e))
					}),
					e.invalid_elements &&
						s(u(e.invalid_elements), function (e) {
							y[e] && delete y[e]
						}),
							...
							if ((c < u.index && l.text(z(e.substr(c, u.index - c))), (d = u[6]))) (d = d.toLowerCase()), ':' === d.charAt(0) && (d = d.substr(1)), o(d)
								...
								if (((d = d.toLowerCase()), ':' === d.charAt(0) && (d = d.substr(1)), (w = d in C), U && M[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !E || (N = a.getElementRule(d)))) {
									if (((_ = !0), E && ((T = N.attributes), (R = N.attributePatterns)), (k = u[8]) ? ((y = k.indexOf('data-mce-type') !== -1), y && b && (_ = !1), (h = []), (h.map = {}), k.replace(O, s)) : ((h = []), (h.map = {})), E && !y)) {
										if (((A = N.attributesRequired), (B = N.attributesDefault), (D = N.attributesForced), (L = N.removeEmptyAttrs), L && !h.length && (_ = !1), D)) for (m = D.length; m--; ) (S = D[m]), (v = S.name), (I = S.value), '{$uid}' === I && (I = 'mce_' + F++), (h.map[v] = I), h.push({name: v, value: I})
										if (B) for (m = B.length; m--; ) (S = B[m]), (v = S.name), v in h.map || ((I = S.value), '{$uid}' === I && (I = 'mce_' + F++), (h.map[v] = I), h.push({name: v, value: I}))
										if (A) {
		...
		r(L, [A, B, D, m], function (e, t, n, r) {
			...
			return function (c, d) {
				...
				;(c = c || {}),
					...
					(c.root_name = c.root_name || 'body'),
					(p.schema = d = d || new t()),
					(p.filterNode = function (e) {
						var t, n, r
					...
					(p.parse = function (t, r) {
						...
						if (
							...
							(g = {}),
							(v = {}),
							(R = s(i('script,style,head,html,body,title,meta,param'), d.getBlockElements())),
							(I = d.getNonEmptyElements()),
							(H = d.children),
							(T = c.validate),
							(F = 'forced_root_block' in r ? r.forced_root_block : c.forced_root_block),
							(O = d.getWhiteSpaceElements()),
							(A = /^[ \t\r\n]+/),
							(L = /[ \t\r\n]+$/),
							(M = /[ \t\r\n]+/g),
							(P = /^[ \t\r\n]+$/),
										...
										if ((n = T ? d.getElementRule(e) : {})) {
											if (R[e] && !D) {
												if (((t = C.firstChild), t && 3 === t.type))
													...
													else for (i = t.next, t.remove(), t = i; t && 3 === t.type; ) (r = t.value), (i = t.next), (0 === r.length || P.test(r)) && (t.remove(), (t = i)), (t = i)
												if (((t = C.lastChild), t && 3 === t.type))
													if (((r = t.value.replace(L, '')), r.length > 0)) (t.value = r), (t = t.prev)
													else for (i = t.prev, t.remove(), t = i; t && 3 === t.type; ) (r = t.value), (i = t.prev), (0 === r.length || P.test(r)) && (t.remove(), (t = i)), (t = i)
											}
							...
							(b = C = new e(r.context || c.root_name, 11)),
							y.parse(t),
							T && B.length && (r.context ? (r.invalid = !0) : f(B)),
							F && ('body' == b.name || r.isRootContent) && o(),
							!r.invalid)
						) {
							for (k in g) {
					...
					c.remove_trailing_brs &&
						p.addNodeFilter('br', function (t) {
							var n,
								r = t.length,
								i,
								o = s({}, d.getBlockElements()),
					...
					c.allow_unsafe_link_target ||
						p.addAttributeFilter('href', function (e) {
							function t(e) {
					...
					c.allow_html_in_named_anchor ||
						p.addAttributeFilter('id,name', function (e) {
					...
					c.fix_list_elements &&
						p.addNodeFilter('ul,ol', function (t) {
					...
					c.validate &&
						d.getValidClasses() &&
						p.addAttributeFilter('class', function (e) {
		...
		r(P, [M, B], function (e, t) {
			return function (n, r) {
				var i = this,
					o = new e(n)
				;(n = n || {}),
					(n.validate = !('validate' in n) || n.validate),
					(i.schema = r = r || new t()),
					(i.writer = o),
					...
					}),
					{
						...
						serialize: function (t, n) {
							var r = this,
								...
								m
							return (
								s.ie && y.select('script,style,select,map').length > 0 ? ((h = t.innerHTML), (t = t.cloneNode(!1)), y.setHTML(t, h)) : (t = t.cloneNode(!0)),
								...
								c(m),
								(p = new i(e, b)),
								(n.content = p.serialize(m)),
								n.cleanup || ((n.content = u.trim(n.content)), (n.content = n.content.replace(/\uFEFF/g, ''))),
			...
			function e(e) {
				function t(t, n) {
					...
					if (((r = t.duplicate()), r.collapse(n), (f = r.parentElement()), f.ownerDocument === e.dom.doc)) {
						...
						if (d < 0) for (l ? r.collapse(!1) : (r.moveToElementText(f), r.collapse(!0), (l = f), (a = !0)), u = 0; 0 !== r.compareEndPoints(n ? 'StartToStart' : 'StartToEnd', t) && 0 !== r.move('character', 1) && f == r.parentElement(); ) u++
						else for (r.collapse(!0), u = 0; 0 !== r.compareEndPoints(n ? 'StartToStart' : 'StartToEnd', t) && 0 !== r.move('character', -1) && f == r.parentElement(); ) u++
			...
			return function (i, s) {
				...
				function d(e, t, n) {
					...
					f(),
						...
						(o = p.width || p.right - p.left),
						(a = p.height || p.bottom - p.top),
						k != e && (C(), (k = e), (U = W = 0)),
							...
							? S(A, function (e, i) {
									...
									return t
										...
										: ((l = _.get('mceResizeHandle' + i)),
										  l && _.remove(l),
										  (l = _.add(X, 'div', {id: 'mceResizeHandle' + i, 'data-mce-bogus': 'all', class: 'mce-resizehandle', unselectable: !0, style: 'cursor:' + i + '-resize; margin:0; padding:0'})),
										  r.ie && (l.contentEditable = !1),
										  _.bind(l, 'mousedown', function (e) {
												e.stopImmediatePropagation(), e.preventDefault(), s(e)
										  }),
										  (e.elm = l),
										  void _.setStyles(l, {left: o * e[0] + P - l.offsetWidth / 2, top: a * e[1] + O - l.offsetHeight / 2}))
							  })
							: f(),
				...
				function p(e) {
					...
					if (!z && !s.removed)
						return (
							...
							t(r, X) && (w(), (n = i.getStart(!0)), t(n, r) && t(i.getEnd(!0), r) && (!q || (r != n && 'IMG' !== n.nodeName))) ? void d(r) : void f()
						)
				}
				function h(e, t, n) {
				...
				return (
					...
					s.on('remove', x),
					{isResizable: l, showResizeRect: d, hideResizeRect: f, updateResizeRect: p, controlSelect: E, destroy: N}
				)
			}
		}),
		r(z, [], function () {
		...
		r(W, [], function () {
			function e(e) {
				return e ? {left: c(e.left), top: c(e.top), bottom: c(e.bottom), right: c(e.right), width: c(e.width), height: c(e.height)} : {left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0}
			}
			function t(t, n) {
		...
		r(q, [_, w, z, h, $], function (e, t, n, r, i) {
			...
			function f(t, i) {
				...
				return (
					(o = i.container()),
					(a = i.offset()),
					g(o) ? (u = s(o, a)) : ((f = o.childNodes), a >= f.length ? ((u = 'after'), (a = f.length - 1)) : (u = 'before'), (o = f[a])),
					l.push(c(o)),
					(p = d(t, o)),
					(p = r.filter(p, n.negate(e.isBogus))),
					(l = l.concat(
						r.map(p, function (e) {
							return c(e)
						}),
			...
			function m(e, t) {
				...
				return t
					? ((n = t.split(',')),
					  ...
					  o ? (g(o) ? h(o, parseInt(a, 10)) : ((a = 'after' === a ? y(o) + 1 : y(o)), new i(o.parentNode, a))) : null)
					: null
			}
			var g = e.isText,
				v = e.isBogus,
		...
		r(K, [w, m, B], function (e, t, n) {
			function r(e, r) {
				...
				function s(e, n, r) {
					...
					return (
						l && ((i = o(l)), i.appendChild(e)),
						r &&
							(i || ((i = u.create('div')), i.appendChild(e)),
							t.each(r, function (t) {
								var n = o(t)
								i.insertBefore(n, e)
							})),
			...
			function o(e) {
				var n,
					r = {classes: [], attrs: {}}
				return (
					(e = r.selector = t.trim(e)),
					'*' !== e &&
						(n = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, function (e, n, i, o, a) {
							switch (n) {
								case '#':
									r.attrs.id = i
									break
			...
			function s(e, t) {
				...
				return 'preview' in t && ((p = t.preview), p === !1)
					? ''
					: ((i = t.block || t.inline || 'span'),
					  (c = a(t.selector)),
					  c.length ? (c[0].name || (c[0].name = i), (i = t.selector), (o = r(c, e))) : (o = r([i], e)),
					  (s = u.select(i, o)[0] || o.firstChild),
					  l(t.styles, function (e, t) {
					  ...
					  u.setStyles(o, {position: 'absolute', left: -65535}),
					  e.getBody().appendChild(o),
					  (f = u.getStyle(e.getBody(), 'fontSize', !0)),
					  (f = /px$/.test(f) ? parseInt(f, 10) : 0),
					  l(p.split(' '), function (t) {
			...
			return (
				r('pre', function (r) {
					...
					var l = r.selection.getRng(),
						u,
						c
					;(u = t.matchNodeNames('pre')),
						l.collapsed ||
							((c = r.selection.getSelectedBlocks()),
							s(a(a(c, u), i), function (e) {
			...
			return function (l) {
				...
				function h() {
					v({
						...
						aligncenter: [
							{selector: 'figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li', styles: {textAlign: 'center'}, inherit: !1, preview: !1, defaultBlock: 'div'},
						...
						;(l = f.inline || f.block),
							...
							me(s, function (e) {
								...
								;(f.inline || f.wrapper) &&
									...
									_(e.parentNode, t, n) && $(f, n, e) && (e = 0),
									f.merge_with_parents &&
				...
				function E(e, t, n, r) {
					...
					function o(n) {
						var i
						return (
							me(f(n.parentNode).reverse(), function (n) {
								var o
					...
					function d(e) {
						...
						if (((e = W(e, p, le)), h.split)) {
							if (((t = X(e, le)), (n = X(e)), t != n)) {
								if ((/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = 'TR' == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && c(n) && n.firstChild && (n = n.firstChild || n), Q.isChildOf(t, n) && !ne(n) && !c(t) && !c(n))) return (t = U(t, 'span', {id: '_start', 'data-mce-type': 'bookmark'})), s(t), void (t = u(le))
								;(t = U(t, 'span', {id: '_start', 'data-mce-type': 'bookmark'})), (n = U(n, 'span', {id: '_end', 'data-mce-type': 'bookmark'})), s(t), s(n), (t = u(le)), (n = u())
							} else t = n = s(t)
						...
						ee.walk(e, function (e) {
							me(e, function (e) {
								i(e), 1 === e.nodeType && 'underline' === l.dom.getStyle(e, 'text-decoration') && e.parentNode && 'underline' === C(e.parentNode) && $({deep: !1, exact: !0, inline: 'span', styles: {textDecoration: 'underline'}}, null, e)
							})
						})
					}
					var p = g(e),
				...
				function W(t, n, r) {
					...
					function d(e, t) {
						...
						if (
							...
							r ||
								(r = Q.getParent(3 == e.nodeType ? e.parentNode : e, function (e) {
									return e != i && u(e)
								})),
							r && n[0].wrapper && (r = f(r, 'ul,ol').reverse()[0] || r),
							!r)
						)
				...
				function $(e, t, n, r) {
					...
					if ('all' != e.remove)
						for (
							me(e.styles, function (i, o) {
								;(i = I(F(i, t), o)), 'number' == typeof o && ((o = i), (r = 0)), (e.remove_similar || !r || D(H(r, o), i)) && Q.setStyle(n, o, ''), (a = 1)
							}),
								a && '' === Q.getAttrib(n, 'style') && (n.removeAttribute('style'), n.removeAttribute('data-mce-style')),
								me(e.attributes, function (e, i) {
									var o
				...
				function q(e, t) {
					...
					t.block &&
						(re
							? r == Q.getRoot() &&
							  ((t.list_block && D(e, t.list_block)) ||
									me(ge(e.childNodes), function (e) {
										te(re, e.nodeName.toLowerCase()) ? (i ? i.appendChild(e) : ((i = U(e, re)), Q.setAttribs(i, l.settings.forced_root_block_attrs))) : (i = 0)
									}))
							: ne(e) && !ne(r) && (n(e, se) || n(e.firstChild, le, 1) || e.insertBefore(Q.create('br'), e.firstChild), n(e, le) || n(e.lastChild, se, 1) || e.appendChild(Q.create('br')))),
						(t.selector && t.inline && !D(t.inline, e)) || Q.remove(e, 1)
				}
				function j(e, t, n) {
				...
				function K(t, n, r, i) {
					...
					function d(e, t) {
						...
						else if (((e = s(Z.getStart())), !e)) for (; (e = Q.get(m)); ) d(e, !1)
					}
					function f() {
						var e, t, i, a, l, u, d
				...
				var J = {},
					...
					ve = o.walk,
					ye = o.extend
				ye(this, {get: g, register: v, unregister: y, apply: w, remove: E, toggle: N, match: S, matchAll: k, matchNode: _, canApply: T, formatChanged: R, getCssText: A}),
					h(),
					m(),
					l.on('BeforeGetContent', function (e) {
						pe && 'raw' != e.format && pe()
					}),
				...
				r = function (r, i) {
					var o = r.length + i.length + 2,
						...
						u = function (o, a, s, l, c) {
							var f = d(o, a, s, l)
							if (null === f || (f.start === a && f.diag === a - l) || (f.end === o && f.diag === o - s)) for (var p = o, h = s; p < a || h < l; ) p < a && h < l && r[p] === i[h] ? (c.push([e, r[p]]), ++p, ++h) : a - o > l - s ? (c.push([n, r[p]]), ++p) : (c.push([t, i[h]]), ++h)
							else {
			...
			return function (e) {
				...
				return (
					...
					e.on('KeyUp', function (t) {
						var o = t.keyCode
						t.isDefaultPrevented() || (((o >= 33 && o <= 36) || (o >= 37 && o <= 40) || 45 === o || t.ctrlKey) && (i(), e.nodeChanged()), (46 !== o && 8 !== o) || e.nodeChanged(), c && a.typing && (e.isDirty() || (r(l[0] && !n.isEq(n.createFromEditor(e), l[0])), e.isDirty() && e.fire('change', {level: l[0], lastLevel: null})), e.fire('TypingUndo'), (c = !1), e.nodeChanged()))
					}),
					...
					(a = {
						...
						add: function (i, o) {
							...
							if (((f = l[s]), e.fire('BeforeAddUndo', {level: i, lastLevel: f, originalEvent: o}).isDefaultPrevented())) return null
			...
			var l = a.matchNodeNames('td th'),
				...
				c = function (a, c, d) {
					...
					var C,
						...
						L = a.selection,
						M = a.dom
					;/^ | $/.test(c) && (c = f(c)), (C = a.parser), (B = d.merge), (x = new n({validate: a.settings.validate}, a.schema)), (A = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>'), (_ = {content: c, format: 'html', selection: !0}), a.fire('BeforeSetContent', _), (c = _.content), c.indexOf('{$caret}') == -1 && (c += '{$caret}'), (c = c.replace(/\{\$caret\}/, A)), (k = L.getRng())
					...
					if ((a._selectionOverrides.showBlockCaretContainer(w), H.invalid)) {
						...
						;(c = w == E ? E.innerHTML : M.getOuterHTML(w)),
							(c = x.serialize(
								C.parse(
		...
		r(le, [d, m, T, y, se, _], function (e, n, r, i, o, a) {
			...
			return function (n) {
				function m(e, t, r, i) {
					...
					if (((a = e.toLowerCase()), (o = D.exec[a]))) return o(a, t, r), n.fire('ExecCommand', {command: e, ui: t, value: r}), !0
					if (
						(s(n.plugins, function (i) {
							if (i.execCommand && i.execCommand(e, t, r)) return n.fire('ExecCommand', {command: e, ui: t, value: r}), (l = !0), !1
						}),
						l)
					)
						return l
				...
				n.on('PreInit', function () {
					...
					l(this, {execCommand: m, queryCommandState: g, queryCommandValue: v, queryCommandSupported: C, addCommands: y, addCommand: b, addQueryStateHandler: x, addQueryValueHandler: w, hasCustomCommand: E}),
					y({
						...
						'Indent,Outdent': function (e) {
							...
							;(t = L.indentation),
								(r = /[a-z%]+$/i.exec(t)),
								(t = parseInt(t, 10)),
								g('InsertUnorderedList') || g('InsertOrderedList')
									? N(e)
									: (L.forced_root_block || R.getParent(A.getNode(), R.isBlock) || B.apply('div'),
									  s(A.getSelectedBlocks(), function (o) {
		...
		r(ue, [m], function (e) {
			function t(e, o) {
				...
				var u = 0 === e.indexOf('//')
				0 !== e.indexOf('/') || u || (e = (s ? s.protocol || 'http' : 'http') + '://mce_host' + e),
					...
					function (e) {
						...
						;(o = !0),
							...
							e.Mixins &&
								...
								u.Mixins && (e.Mixins = u.Mixins.concat(e.Mixins))),
							e.Methods &&
		...
		r(xe, [ce, m, de, he, ge, ve, g, ye, be, Ce], function (e, t, n, r, i, o, a, s, l, u) {
			...
			function d(e) {
				...
				function i(t) {
					t.preventDefault(), 'mousewheel' == t.type ? ((t.deltaY = -0.025 * t.wheelDelta), t.wheelDeltaX && (t.deltaX = -0.025 * t.wheelDeltaX)) : ((t.deltaX = 0), (t.deltaY = t.detail)), (t = e.fire('wheel', t))
				}
				var o, s, l, u, c, d
				...
				v = {
					...
					init: function (e) {
						...
						;(i.settings = e = t.extend({}, i.Defaults, e)),
							...
							(o = e.classes),
							o && (i.Defaults && ((u = i.Defaults.classes), u && o != u && n(u)), n(o)),
						...
						return (
							...
							e
								? ((o = n.deltaW),
								  ...
								  (i = e.w),
								  i !== s && ((i = i < n.minW ? n.minW : i), (i = i > n.maxW ? n.maxW : i), (n.w = i), (n.innerW = i - o)),
								  (i = e.h),
								  i !== s && ((i = i < n.minH ? n.minH : i), (i = i > n.maxH ? n.maxH : i), (n.h = i), (n.innerH = i - a)),
								  (i = e.innerW),
								  i !== s && ((i = i < n.minW - o ? n.minW - o : i), (i = i > n.maxW - o ? n.maxW - o : i), (n.innerW = i), (n.w = i + o)),
								  (i = e.innerH),
								  i !== s && ((i = i < n.minH - a ? n.minH - a : i), (i = i > n.maxH - a ? n.maxH - a : i), (n.innerH = i), (n.h = i + a)),
								  e.contentW !== s && (n.contentW = e.contentW),
								  e.contentH !== s && (n.contentH = e.contentH),
								  (r = t._lastLayoutRect),
								  (r.x === n.x && r.y === n.y && r.w === n.w && r.h === n.h) || ((l = m.repaintControls), l && l.map && !l.map[t._id] && (l.push(t), (l.map[t._id] = !0)), (r.x = n.x), (r.y = n.y), (r.w = n.w), (r.h = n.h)),
								  t)
								: n
						)
					},
					repaint: function () {
						...
						;(u = document.createRange
							...
							(a = o.left + o.right),
							(s = o.top + o.bottom),
							i.x !== l.x && ((t.left = u(i.x) + 'px'), (l.x = i.x)),
							i.y !== l.y && ((t.top = u(i.y) + 'px'), (l.y = i.y)),
							i.w !== l.w && ((c = u(i.w - a)), (t.width = (c >= 0 ? c : 0) + 'px'), (l.w = i.w)),
							i.h !== l.h && ((c = u(i.h - s)), (t.height = (c >= 0 ? c : 0) + 'px'), (l.h = i.h)),
							e._hasBody && i.innerW !== l.innerW && ((c = u(i.innerW)), (r = e.getEl('body')), r && ((n = r.style), (n.width = (c >= 0 ? c : 0) + 'px')), (l.innerW = i.innerW)),
							e._hasBody && i.innerH !== l.innerH && ((c = u(i.innerH)), (r = r || e.getEl('body')), r && ((n = n || r.style), (n.height = (c >= 0 ? c : 0) + 'px')), (l.innerH = i.innerH)),
		...
		r(_e, [g], function (e) {
			function t(e) {
				var t,
					...
					l,
					u = Math.max
				return (t = e.documentElement), (n = e.body), (r = u(t.scrollWidth, n.scrollWidth)), (i = u(t.clientWidth, n.clientWidth)), (o = u(t.offsetWidth, n.offsetWidth)), (a = u(t.scrollHeight, n.scrollHeight)), (s = u(t.clientHeight, n.clientHeight)), (l = u(t.offsetHeight, n.offsetHeight)), {width: r < o ? i : r, height: a < l ? s : a}
			}
			function n(e) {
				var t, n
					...
					function r() {
						function n(n, r, a, s, l) {
							var u,
								c = i._id + '-scroll' + n,
								d = i.classPrefix
							e(i.getEl()).append('<div id="' + c + '" class="' + d + 'scrollbar ' + d + 'scrollbar-' + n + '"><div id="' + c + 't" class="' + d + 'scrollbar-thumb"></div></div>'),
								(i.draghelper = new t(c + 't', {
									start: function () {
				...
				h = e.extend({
					...
					init: function (e) {
						...
						r._super(e),
							...
							r.state.set('fixed', !0),
							e.buttons && ((r.statusbar = new t({layout: 'flex', border: '1 0 0 0', spacing: 3, padding: 10, align: 'center', pack: r.isRtl() ? 'start' : 'end', defaults: {type: 'button'}, items: e.buttons})), r.statusbar.classes.add('foot'), r.statusbar.parent(r)),
				...
				;(a.windows = s),
					...
					(a.open = function (t, r) {
						...
						return (
							...
							t.body && (t.items = {defaults: t.defaults, type: t.bodyType || 'form', items: t.body, data: t.data, callbacks: t.commands}),
							t.url ||
								t.buttons ||
								(t.buttons = [
									{
		...
		r(ze, [I, T, y, Fe, A, C, d, m, c, k, $, oe], function (e, t, n, r, i, o, a, s, l, u, c, d) {
			return function (f) {
				...
				function v(e) {
					var t
					return e.dataTransfer && ((t = e.dataTransfer.getData(de)), t && t.indexOf(ce) >= 0) ? ((t = t.substr(ce.length).split(',')), {id: unescape(t[0]), html: unescape(t[1])}) : null
				}
				function y(e) {
				...
				function b() {
					...
					function h(e) {
						...
						d(e) ||
							...
							(t = new E(function () {})),
							t.observe(f.getDoc(), {childList: !0, attributes: !0, subtree: !0, attributeFilter: ['style']}),
								...
								;(n = f.selection.getRng()),
									...
									r.length
										? ((i = x.createFragment()),
										  ...
										  (o = x.getParent(n.startContainer, x.isBlock)),
										  x.isEmpty(o) ? Z(o).empty().append(i) : n.insertNode(i),
		...
		r($e, [u, m, z], function (e, t, n) {
			return function (r, i) {
				function o(e) {
					var t, n
					return (n = {'image/jpeg': 'jpg', 'image/jpg': 'jpg', 'image/gif': 'gif', 'image/png': 'png'}), (t = n[e.blob().type.toLowerCase()] || 'dat'), e.filename() + '.' + t
				}
				function a(e, t) {
				...
				function l(e, t, n, r) {
					...
					;(o = new XMLHttpRequest()),
						...
						(s = new FormData()),
						s.append('file', e.blob(), e.filename()),
						o.send(s)
				}
				function u() {
		...
		r(Ge, [h, $e, je, Ye, Xe, Ke], function (e, t, n, r, i, o) {
			return function (a) {
				...
				function u(e, t, n) {
					var r = 0
					do (r = e.indexOf(t, r)), r !== -1 && ((e = e.substring(0, r) + n + e.substr(r + t.length)), (r += n.length - t.length + 1))
					while (r !== -1)
					return e
				}
				function c(e, t, n) {
				...
				function d(t, n) {
					e.each(a.undoManager.data, function (r) {
						'fragmented' === r.type
							? (r.fragments = e.map(r.fragments, function (e) {
									return c(e, t, n)
							  }))
				...
				function f() {
					return a.notificationManager.open({text: a.translate('Image uploading...'), type: 'info', timeout: -1, progressBar: !0})
				}
				function p(e, t) {
					C.removeByUri(e.src), d(e.src, t), a.$(e).attr({src: E.images_reuse_filename ? t + l() : t, 'data-mce-src': a.convertURL(t, 'src')})
				}
				function h(n) {
					return (
						x || (x = new t(N, {url: E.images_upload_url, basePath: E.images_upload_base_path, credentials: E.images_upload_credentials, handler: E.images_upload_handler})),
						v().then(
							s(function (t) {
								var r
								return (
										...
										s(function (r) {
											return (
												(r = e.map(r, function (e, n) {
													var r = t[n].image
													return e.status && a.settings.images_replace_blob_uris !== !1 ? p(r, e.url) : e.error && o.uploadError(a, e.error), {element: r, status: e.status}
												})),
												n && n(r),
												r
											)
		...
		r(et, [z, h, _, Qe, W, ie, U], function (e, t, n, r, i, o, a) {
			...
			function h(e, n, i) {
				...
				return (
					...
					(a = u(o, n)),
					a && ((a = u(d(e, a), n)), a && m(a.node)) ? p(a, n) : null
				)
			}
		...
		r(nt, [_, h, z, c, w, tt], function (e, t, n, r, i, o) {
			var a = e.isContentEditableFalse,
				...
				d = function (e, t, n, r) {
					...
					return e.dom.setStyles(o, {position: 'absolute', opacity: 0.5, overflow: 'hidden', border: 0, padding: 0, margin: 0, width: n, height: r}), e.dom.setStyles(i, {margin: 0, boxSizing: 'border-box'}), o.appendChild(i), o
				},
				f = function (e, t) {
		...
		r(rt, [d, oe, $, k, ie, Je, Ze, et, _, T, W, I, z, h, c, nt], function (e, t, n, r, i, o, a, s, l, u, c, d, f, p, h, m) {
			...
			function v(u) {
				...
				function A(e, t, n) {
					var r
					return (r = u.fire('ShowCaret', {target: t, direction: e, before: n})), r.isDefaultPrevented() ? null : (R(t, e === -1), se.show(n, t))
				}
				function B(e) {
					var t
		...
		r(at, [w, g, N, R, A, O, P, Y, J, te, ne, re, le, ue, E, f, Le, Ie, B, L, ze, d, m, c, Ue, We, Ve, Ge, rt, it, ot, Ke], function (e, n, r, i, o, a, s, l, u, c, d, f, p, h, m, g, v, y, b, C, x, w, E, N, _, S, k, T, R, A, B, D) {
			function L(e, t, i) {
				...
				;(a = o.documentBaseUrl = i.documentBaseURL),
					...
					l && l.external_plugins && t.external_plugins && (t.external_plugins = H({}, l.external_plugins, t.external_plugins)),
					(o.settings = t),
					...
					o.setDirty(!1),
					(o.plugins = {}),
					(o.documentBaseURI = new h(t.document_base_url || a, {base_uri: s})),
					(o.baseURI = s),
					(o.contentCSS = []),
					(o.contentStyles = []),
					(o.shortcuts = new k(o)),
				...
				(L.prototype = {
					render: function () {
						...
						function t() {
							...
							E.isArray(r.plugins) && (r.plugins = r.plugins.join(' ')),
								I(r.external_plugins, function (e, t) {
						...
						if (n.getElement() && w.contentEditable) {
							...
							a &&
								((n.formElement = a),
								r.hidden_input && !/TEXTAREA|INPUT/i.test(n.getElement().nodeName) && (M.insertAfter(M.create('input', {type: 'hidden', name: i}), i), (n.hasHiddenInput = !0)),
								(n.formEventDelegate = function (e) {
									n.fire(e.type, e)
								}),
								M.bind(a, 'submit reset', n.formEventDelegate),
								n.on('reset', function () {
					...
					init: function () {
						...
						var t = this,
							...
							m = []
						if (
							((t.rtl = n.rtl_ui || t.editorManager.i18n.rtl),
							t.editorManager.i18n.setCode(n.language),
							(n.aria_label = n.aria_label || M.getAttrib(r, 'aria-label', t.getLang('aria.rich_text_area'))),
							t.fire('ScriptsLoaded'),
							n.theme && ('function' != typeof n.theme ? ((n.theme = n.theme.replace(/-/, '')), (u = P.get(n.theme)), (t.theme = new u(t, P.urls[n.theme])), t.theme.init && t.theme.init(t, P.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, ''), t.$)) : (t.theme = n.theme)),
							I(n.plugins.replace(/\-/g, '').split(/[ ,]/), e),
							n.render_ui && t.theme && ((t.orgDisplay = r.style.display), 'function' != typeof n.theme ? ((i = n.width || r.style.width || r.offsetWidth), (o = n.height || r.style.height || r.offsetHeight), (a = n.min_height || 100), (p = /^[0-9\.]+(|px)$/i), p.test('' + i) && (i = Math.max(parseInt(i, 10), 100)), p.test('' + o) && (o = Math.max(parseInt(o, 10), a)), (l = t.theme.renderUI({targetNode: r, width: i, height: o, deltaWidth: n.delta_width, deltaHeight: n.delta_height})), n.content_editable || ((o = (l.iframeHeight || o) + ('number' == typeof o ? l.deltaHeight || 0 : '')), o < a && (o = a))) : ((l = n.theme(t, r)), l.editorContainer.nodeType && (l.editorContainer.id = l.editorContainer.id || t.id + '_parent'), l.iframeContainer.nodeType && (l.iframeContainer.id = l.iframeContainer.id || t.id + '_iframecontainer'), (o = l.iframeHeight || r.offsetHeight)), (t.editorContainer = l.editorContainer)),
							n.content_css &&
								I(F(n.content_css), function (e) {
						...
						if (
							...
							M.setAttrib(y, 'src', c || 'javascript:""'),
							(t.contentAreaContainer = l.iframeContainer),
							(t.iframeElement = y),
							(s = M.add(l.iframeContainer, y)),
							q)
						)
							try {
								t.getDoc()
					...
					initContentBody: function (t) {
						...
						r.inline || (n.getElement().style.visibility = n.orgVisibility),
							...
							n.readonly || (n.inline && 'static' == M.getStyle(h, 'position', !0) && (h.style.position = 'relative'), (h.contentEditable = n.getParam('content_editable_state', !0))),
							(h.disabled = !1),
							...
							n.fire('PreInit'),
							r.browser_spellcheck || r.gecko_spellcheck || ((p.body.spellcheck = !1), M.setAttrib(h, 'spellcheck', 'false')),
							(n.quirks = new x(n)),
							n.fire('PostRender'),
							...
							n.contentStyles.length > 0 &&
								((m = ''),
								I(n.contentStyles, function (e) {
									m += e + '\r\n'
								}),
								n.dom.addStyle(m)),
							I(n.contentCSS, function (e) {
					...
					getParam: function (e, t, n) {
						...
						return 'hash' === n
							? ((i = {}),
							  'string' == typeof r
									? I(r.indexOf('=') > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(','), function (e) {
							...
							return (
								...
								/TEXTAREA|INPUT/i.test(n.nodeName)
									...
									: (t.inline || (n.innerHTML = r),
									  (i = M.getParent(t.id, 'form')) &&
											I(i.elements, function (e) {
					...
					addVisual: function (e) {
						...
						;(e = e || n.getBody()),
							...
							I(i.select('table,a', e), function (e) {
								var t
								switch (e.nodeName) {
									case 'TABLE':
		...
		r(ut, [at, g, w, ue, d, m, u, pe, st, lt, N], function (e, t, n, r, i, o, a, s, l, u, c) {
			...
			return (
					...
					init: function (n) {
						...
						function d() {
							...
							var u = 0,
								...
								g
							return (
								m.unbind(window, 'ready', d),
								l('onpageload'),
								(g = t.unique(c(n))),
								n.types
									? void v(n.types, function (e) {
											o.each(g, function (t) {
				...
				y(x, s),
				x.setup(),
				(window.tinymce = window.tinyMCE = x),
				x
			)
		}),
				...
				(r.prototype = {
					send: function (n) {
						...
						;(n = i(this.settings, n)),
							...
							(n.data = e.serialize({id: n.id || 'c' + this.count++, method: n.method, params: n.params})),
		...
		r(mt, [], function () {
			...
			return (
				...
				(u = !!o.addBehavior),
				u && o.addBehavior('#default#userData'),
				(i = {
					key: function (e) {
						return s[e]
					},
			...
			return e.extend({
				...
				renderHtml: function () {
					...
					return (
						...
						(u = '<i id="' + t + '-status" class="mce-status mce-ico" style="display: none"></i>'),
						...
						'<div id="' + t + '" class="' + e.classes + '"><input id="' + t + '-inp" class="' + r + 'textbox" value="' + e.encode(i, !1) + '" hidefocus="1"' + l + ' placeholder="' + e.encode(n.placeholder) + '" />' + u + s + '</div>'
					)
				},
				value: function (e) {
				...
				showAutoComplete: function (e, n) {
					...
					r.menu ? r.menu.items().remove() : (r.menu = t.create({type: 'menu', classes: 'combobox-menu', layout: 'flow'}).parent(r).renderTo()),
						o.each(e, function (e) {
							r.menu.add({text: e.title, url: e.previewUrl, match: n, classes: 'menu-item-ellipsis', onclick: i(e.value, e.title)})
						}),
						r.menu.renderNew(),
						r.hideMenu(),
		...
		r(St, [], function () {
			function e(e) {
				function i(e, i, o) {
					var a, s, l, u, c, d
					return (a = 0), (s = 0), (l = 0), (e /= 255), (i /= 255), (o /= 255), (c = t(e, t(i, o))), (d = n(e, n(i, o))), c == d ? ((l = c), {h: 0, s: 0, v: 100 * l}) : ((u = e == c ? i - o : o == c ? e - i : o - e), (a = e == c ? 3 : o == c ? 1 : 5), (a = 60 * (a - u / (d - c))), (s = (d - c) / d), (l = d), {h: r(a), s: r(100 * s), v: r(100 * l)})
				}
				function o(e, i, o) {
					var a, s, l, u
			...
			var a = {},
				...
				b = function (e, t, n) {
					...
					if (r) {
						var i = function (t) {
							return 0 === t.length
								? void e.statusLevel('none')
								: void r({url: t, type: n}, function (t) {
										var n = y(t)
		...
		r(Ft, [xe, Pe, Ae, m, h, w, ut, d, It], function (e, t, n, r, i, o, a, s, l) {
			...
			function d(e) {
				...
				function i(t) {
					return function () {
						...
						e.on('nodeChange', function (i) {
							var o,
								a = null
							;(o = l.getFontFamily(e.getBody(), i.element)),
								f(t, function (e) {
					...
					return function () {
						...
						e.on('nodeChange', function (r) {
							var i,
								o,
								a = null
							;(i = l.getFontSize(e.getBody(), r.element)),
								(o = l.toPt(i)),
								f(t, function (e) {
				...
				var v
				;(v = s()),
					f({bold: 'Bold', italic: 'Italic', underline: 'Underline', strikethrough: 'Strikethrough', subscript: 'Subscript', superscript: 'Superscript'}, function (t, n) {
						e.addButton(n, {
							tooltip: t,
							onPostRender: u(n),
							onclick: function () {
					...
					f({outdent: ['Decrease indent', 'Outdent'], indent: ['Increase indent', 'Indent'], cut: ['Cut', 'Cut'], copy: ['Copy', 'Copy'], paste: ['Paste', 'Paste'], help: ['Help', 'mceHelp'], selectall: ['Select all', 'SelectAll'], removeformat: ['Clear formatting', 'RemoveFormat'], visualaid: ['Visual aids', 'mceToggleVisualAid'], newdocument: ['New document', 'mceNewDocument']}, function (t, n) {
						e.addButton(n, {tooltip: t[0], cmd: t[1]})
					}),
					f({blockquote: ['Blockquote', 'mceBlockQuote'], subscript: ['Subscript', 'Subscript'], superscript: ['Superscript', 'Superscript'], alignleft: ['Align left', 'JustifyLeft'], aligncenter: ['Align center', 'JustifyCenter'], alignright: ['Align right', 'JustifyRight'], alignjustify: ['Justify', 'JustifyFull'], alignnone: ['No alignment', 'JustifyNone']}, function (t, n) {
				...
				e.addButton('undo', {tooltip: 'Undo', onPostRender: c('undo'), cmd: 'undo'}),
					e.addButton('redo', {tooltip: 'Redo', onPostRender: c('redo'), cmd: 'redo'}),
					e.addMenuItem('newdocument', {text: 'New document', icon: 'newdocument', cmd: 'mceNewDocument'}),
					e.addMenuItem('undo', {text: 'Undo', icon: 'undo', shortcut: 'Meta+Z', onPostRender: c('undo'), cmd: 'undo'}),
					e.addMenuItem('redo', {text: 'Redo', icon: 'redo', shortcut: 'Meta+Y', onPostRender: c('redo'), cmd: 'redo'}),
					...
					f({cut: ['Cut', 'Cut', 'Meta+X'], copy: ['Copy', 'Copy', 'Meta+C'], paste: ['Paste', 'Paste', 'Meta+V'], selectall: ['Select all', 'SelectAll', 'Meta+A'], bold: ['Bold', 'Bold', 'Meta+B'], italic: ['Italic', 'Italic', 'Meta+I'], underline: ['Underline', 'Underline', 'Meta+U'], strikethrough: ['Strikethrough', 'Strikethrough'], subscript: ['Subscript', 'Subscript'], superscript: ['Superscript', 'Superscript'], removeformat: ['Clear formatting', 'RemoveFormat']}, function (t, n) {
		...
		r(jt, [bt, we, qt], function (e, t, n) {
			...
			var i = e.extend({
				...
				showMenu: function (e) {
					var n = this,
						r
					return n.menu && n.menu.visible() && e !== !1
						? n.hideMenu()
						: (n.menu ||
								((r = n.state.get('menu') || []),
								r.length ? (r = {type: 'menu', items: r}) : (r.type = r.type || 'menu'),
								r.renderTo ? (n.menu = r.parent(n).show().renderTo()) : (n.menu = t.create(r).parent(n).renderTo()),
								n.fire('createmenu'),
								n.menu.reflow(),
			...
			return e.extend({
				...
				renderHtml: function () {
					...
					function r(e) {
						var n = s.match || ''
						return n
							? e.replace(new RegExp(t(n), 'gi'), function (e) {
			...
			return e.extend({
				...
				postRender: function () {
					...
					function o(t, n) {
						function o(o) {
							var a
							;(a = s.value()), (a = i(t, n, e(t, n, a) + 0.05 * o)), (a = r(a, t, n)), s.value(a), s.fire('dragstart', {value: a}), s.fire('drag', {value: a}), s.fire('dragend', {value: a})
						}

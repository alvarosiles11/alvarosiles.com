	...
	s('1', tinymce.Env),
									...
									s = function () {
										...
										e.settings.stateSelector &&
											...
											e.settings.disabledStateSelector &&
												t.selectorChanged(e.settings.disabledStateSelector, function (t) {
													e.disabled(t)
												})
									}
		...
		a('d', ['a', '8', 'j', 'b', '9', 'k'], function (e, t, n, r, i, o) {
			var a = function (e) {
				...
				u = function (e, t, n, r, i, o) {
					return (o = a({x: t, y: n, w: o.w, h: o.h})), e && (o = e({elementRect: a(r), contentAreaRect: a(i), panelRect: o})), o
				},
				d = function (a) {
					var d,
						f = a.settings,
						...
						h = function (t, n) {
							...
							if (!a.removed) {
								...
								;(v = ['bc-tc', 'tc-bc', 'tl-bl', 'bl-tl', 'tr-br', 'br-tr']),
									...
									(b = 25),
									'inline' !== e.getStyle(t.element, 'display', !0) && ((d.w = t.element.clientWidth), (d.h = t.element.clientHeight)),
									a.inline || (p.w = a.getDoc().documentElement.offsetWidth),
									a.selection.controlSelection.isResizable(t.element) && d.w < b && (d = o.inflate(d, 0, 8)),
									(r = o.findBestRelativePosition(i, d, p, v)),
									(d = o.clamp(d, p)),
									r ? ((g = o.relativePosition(i, d, r)), l(h, u(y, g.x, g.y, d, p, i))) : ((p.h += i.h), (d = o.intersect(p, d)), d ? ((r = o.findBestRelativePosition(i, d, p, ['bc-tc', 'bl-tl', 'br-tr'])), r ? ((g = o.relativePosition(i, d, r)), l(h, u(y, g.x, g.y, d, p, i))) : l(h, u(y, d.x, d.y, d, p, i))) : h.hide()),
									c(h, r, function (e, t) {
										return e === t
									})
							}
						...
						C = function (e) {
							var t,
								...
								r,
								i = p()
							for (r = a.$(e).parents().add(e), t = r.length - 1; t >= 0; t--) for (n = i.length - 1; n >= 0; n--) if (i[n].predicate(r[t])) return {toolbar: i[n], element: r[t]}
							return null
						}
					a.on('click keyup setContent ObjectResized', function (e) {
						...
						a.on('ResizeEditor ResizeWindow', g(!0)),
						a.on('nodeChange', g(!1)),
						a.on('remove', function () {
							t.each(p(), function (e) {
		...
		a('f', ['8', '9', '1'], function (e, t, n) {
			var r = function (e) {
				...
				d = function (t) {
					...
					return {type: 'panel', name: 'sidebar', layout: 'stack', classes: 'sidebar', items: [{type: 'toolbar', layout: 'stack', classes: 'sidebar-toolbar', items: n}]}
				}
		...
		a('4', ['8', '9', 'a', 'b', 'c', 'd', 'e', 'f', 'g', '6'], function (e, t, n, r, i, o, a, s, l, c) {
			var u = function (e) {
				...
				f = function (e) {
					return {type: 'panel', layout: 'stack', classes: 'edit-aria-container', border: '1 0 0 0', items: [d('0'), s.createSidebar(e)]}
				},
				p = function (e, p, m) {
					var h,
						g,
						...
						b = e.settings
					return (
						m.skinUiCss && n.styleSheetLoader.load(m.skinUiCss, l.fireSkinLoaded(e)),
						(h = p.panel = t.create({type: 'panel', role: 'application', classes: 'tinymce', style: 'visibility: hidden', layout: 'stack', border: 1, items: [b.menubar === !1 ? null : {type: 'menubar', border: '0 0 1 0', items: i.createMenuButtons(e)}, r.createToolbars(e, b.toolbar_items_size), s.hasSidebar(e) ? f(e) : d('1 0 0 0')]})),
						b.resize !== !1 &&
							(g = {
								type: 'resizehandle',
								direction: b.resize,
						...
						b.statusbar !== !1 && h.add({type: 'panel', name: 'statusbar', classes: 'statusbar', layout: 'flow', border: '1 0 0 0', ariaRoot: !0, items: [{type: 'elementpath', editor: e}, g]}),
						e.fire('BeforeRenderUI'),
						e.on('SwitchMode', u(h)),
						h.renderBefore(m.targetNode).reflow(),
						b.readonly && e.setMode('readonly'),
						b.width && n.setStyle(h.getEl(), 'width', b.width),
						e.on('remove', function () {
							h.remove(), (h = null)
						}),
						a.addKeys(e, h),
						o.addContextualToolbars(e),
						{iframeContainer: h.find('#iframe')[0].getEl(), editorContainer: h.getEl()}
					)
				}
			return {render: p}
		}),
		s('h', tinymce.ui.FloatPanel),
		a('5', ['8', '9', 'a', 'h', 'b', 'c', 'd', 'e', 'g'], function (e, t, n, r, i, o, a, s, l) {
			var c = function (e, c, u) {
				...
				var m = function () {
						if (d && d.moveRel && d.visible() && !d._fixed) {
							...
							d.fixed(!1)
								.moveRel(r, e.rtl ? ['tr-br', 'br-tr'] : ['tl-bl', 'bl-tl', 'tr-br'])
								.moveBy(i, o)
						}
					},
					h = function () {

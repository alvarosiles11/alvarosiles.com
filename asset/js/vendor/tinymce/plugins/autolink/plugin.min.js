tinymce.PluginManager.add('autolink', function (e) {
	...
	function i(e, t, n) {
		...
		if ('A' != e.selection.getNode().tagName) {
			...
			c = l
			do i(u, l >= 2 ? l - 2 : 0), o(u, l >= 1 ? l - 1 : 0), (l -= 1), (g = s.toString())
			while (' ' != g && '' !== g && 160 != g.charCodeAt(0) && l - 2 >= 0 && g != n)
	...
	var o,
		a = /^(https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.|(?:mailto:)?[A-Z0-9._%+\-]+@)(.+)$/i
	return (
		e.settings.autolink_pattern && (a = e.settings.autolink_pattern),
		e.on('keydown', function (t) {
			if (13 == t.keyCode) return r(e)
		}),
		tinymce.Env.ie
			? void e.on('focus', function () {
					if (!o) {
						o = !0
						try {

tinymce.PluginManager.add('charmap', function (e) {
	...
	return e.addCommand('mceShowCharmap', s), e.addButton('charmap', {icon: 'charmap', tooltip: 'Special character', cmd: 'mceShowCharmap'}), e.addMenuItem('charmap', {icon: 'charmap', text: 'Special character', cmd: 'mceShowCharmap', context: 'insert'}), {getCharMap: o, insertChar: a}
})

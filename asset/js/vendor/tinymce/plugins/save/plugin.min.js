tinymce.PluginManager.add('save', function (e) {
	...
	e.addCommand('mceSave', t), e.addCommand('mceCancel', r), e.addButton('save', {icon: 'save', text: 'Save', cmd: 'mceSave', disabled: !0, onPostRender: i}), e.addButton('cancel', {text: 'Cancel', icon: !1, cmd: 'mceCancel', disabled: !0, onPostRender: i}), e.addShortcut('Meta+S', '', 'mceSave')
})

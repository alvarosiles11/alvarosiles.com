	...
	r('tinymce/pasteplugin/Utils', ['tinymce/util/Tools', 'tinymce/html/DomParser', 'tinymce/html/Schema'], function (e, t, n) {
		...
		r('tinymce/pasteplugin/Clipboard', ['tinymce/Env', 'tinymce/dom/RangeUtils', 'tinymce/util/VK', 'tinymce/pasteplugin/Utils', 'tinymce/pasteplugin/SmartPaste', 'tinymce/util/Delay'], function (e, t, n, r, i, o) {
			return function (a) {
				...
				function l(e) {
					...
					var t,
						n = a.dom.getParent(a.selection.getStart(), a.dom.isBlock),
						i = a.settings.forced_root_block
					i && ((t = a.dom.createHTML(i, a.settings.forced_root_block_attrs)), (t = t.substr(0, t.length - 3) + '>')),
						(n && /^(PRE|DIV)$/.test(n.nodeName)) || !i
							? (e = r.filter(e, [[/\n/g, '<br>']]))
							: ((e = r.filter(e, [
									[/\n\n/g, '</p>' + t],
									[/^(.*<\/p>)(<p>)$/, t + '$1'],
				...
				function c() {
					...
					;(E = r.add(a.getBody(), 'div', {id: 'mcepastebin', contentEditable: !0, 'data-mce-bogus': 'all', style: 'position: absolute; top: ' + l + 'px;width: 10px; height: 10px; overflow: hidden; opacity: 0'}, A)),
				...
				function v(e, t, n) {
					...
					if (((o.src = r), g(a.settings, o))) {
						...
						;(c = u.findFirst(function (e) {
							...
							c ? (l = c) : ((l = u.create(P(), n, i)), u.add(l)),
							s('<img src="' + l.blobUri() + '">')
					} else s('<img src="' + r + '">')
				}
				function b(e, t) {
				...
				function N() {
					...
					a.on('paste', function (n) {
						var r = new Date().getTime(),
							...
							h = 'text' == k.pasteFormat || _
						return (
							(_ = !1),
							n.isDefaultPrevented() || y(n)
								? void u()
								: !m(s) && b(n, i())
								? void u()
								: (f || n.preventDefault(),
				...
				c.on('BeforePastePreProcess', function (d) {
					...
					function p(t, n) {
						...
						return (
							...
							/(bold)/i.test(o['font-weight']) && (delete o['font-weight'], t.wrap(new i('b', 1))),
							/(italic)/i.test(o['font-style']) && (delete o['font-style'], t.wrap(new i('i', 1))),
		...
		r('tinymce/pasteplugin/Plugin', ['tinymce/PluginManager', 'tinymce/pasteplugin/Clipboard', 'tinymce/pasteplugin/WordFilter', 'tinymce/pasteplugin/Quirks'], function (e, t, n, r) {
			...
			e.add('paste', function (o) {
				...
				function s() {
					if ('text' == c.pasteFormat) (c.pasteFormat = 'html'), o.fire('PastePlainTextToggle', {state: !1})
					else if (((c.pasteFormat = 'text'), o.fire('PastePlainTextToggle', {state: !0}), !a())) {
				...
				function l() {
					var e = this
					e.active('text' === c.pasteFormat),
						o.on('PastePlainTextToggle', function (t) {
							e.active(t.state)
						})
				}
				var c,
					u = this,
					d = o.settings
				return /(^|[ ,])powerpaste([, ]|$)/.test(d.plugins) && e.get('powerpaste')
					...
					: ((u.clipboard = c = new t(o)),
					  (u.quirks = new r(o)),
					  (u.wordFilter = new n(o)),
					  o.settings.paste_as_text && (u.clipboard.pasteFormat = 'text'),
					  d.paste_preprocess &&
							o.on('PastePreProcess', function (e) {
								d.paste_preprocess.call(u, u, e)
							}),
					  d.paste_postprocess &&
							o.on('PastePostProcess', function (e) {
					  ...
					  o.addCommand('mceTogglePlainTextPaste', s),
					  o.addButton('pastetext', {icon: 'pastetext', tooltip: 'Paste as text', onclick: s, onPostRender: l}),
					  void o.addMenuItem('pastetext', {text: 'Paste as text', selectable: !0, active: c.pasteFormat, onclick: s, onPostRender: l}))
			})
		}),

...
export default class TcpSocket extends EventEmitter {
     ...
     */
    constructor(id: number, eventEmitter: NativeEventEmitter, address?: string);
    /** @protected */
    ...
    _dataListener: import("react-native").EmitterSubscription;
    _errorListener: import("react-native").EmitterSubscription;
    _closeListener: import("react-native").EmitterSubscription;
    _connectListener: import("react-native").EmitterSubscription;
    /**
     * @protected
     */
     ...
     * @param {() => void} [callback]
     */
    connect(options: ConnectionOptions, callback?: () => void): TcpSocket;
    _destroyed: boolean;
    /**
     ...
     */
    setEncoding(encoding?: BufferEncoding): TcpSocket;
    /**
